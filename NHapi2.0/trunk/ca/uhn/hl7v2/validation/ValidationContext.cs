...
namespace ca.uhn.hl7v2.validation
{
	...
	public interface ValidationContext
	{
		...
		/// </returns>
		PrimitiveTypeRule[] getPrimitiveRules(System.String theVersion, System.String theTypeName, Primitive theType);
		...
		/// and trigger event 
		/// </returns>
		MessageRule[] getMessageRules(System.String theVersion, System.String theMessageType, System.String theTriggerEvent);
		...
		/// </returns>
		EncodingRule[] getEncodingRules(System.String theVersion, System.String theEncoding);
	}
}