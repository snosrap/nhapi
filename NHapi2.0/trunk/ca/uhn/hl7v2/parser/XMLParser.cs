...
using GenericPrimitive = ca.uhn.hl7v2.model.GenericPrimitive;
...
namespace ca.uhn.hl7v2.parser
{
	...
	public abstract class XMLParser:Parser
	{
		...
		//UPGRADE_NOTE: The initialization of  'log' was moved to static method 'ca.uhn.hl7v2.parser.XMLParser'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
