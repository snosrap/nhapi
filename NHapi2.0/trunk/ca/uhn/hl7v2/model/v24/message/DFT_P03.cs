 ...
 * 14: DFT_P03_INSURANCE (a Group object) <b>optional repeating</b><br>
...
public class DFT_P03 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("DFT_P03_COMMON_ORDER", "2.4"), false, true);
	      this.add(factory.getGroupClass("DFT_P03_FINANCIAL", "2.4"), true, true);
	      ...
	      this.add(factory.getGroupClass("DFT_P03_INSURANCE", "2.4"), false, true);
