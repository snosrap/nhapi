...
/**
 * <p>Represents a ORN_O08 message structure (see chapter 4). This structure contains the 
...
public class ORN_O08 : AbstractMessage  {
	...
	/** 
	 * Creates a new ORN_O08 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ORN_O08_RESPONSE", "2.4"), false, false);
