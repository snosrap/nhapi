...
/**
 * <p>Represents a ADT_A05 message structure (see chapter 3). This structure contains the 
...
public class ADT_A05 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ADT_A05_PROCEDURE", "2.4"), false, true);
	      this.add(factory.getSegmentClass("GT1", "2.4"), false, true);
	      this.add(factory.getGroupClass("ADT_A05_INSURANCE", "2.4"), false, true);
