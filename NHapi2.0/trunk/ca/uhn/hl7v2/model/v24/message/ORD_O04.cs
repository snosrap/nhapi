...
/**
 * <p>Represents a ORD_O04 message structure (see chapter 4). This structure contains the 
...
public class ORD_O04 : AbstractMessage  {
	...
	/** 
	 * Creates a new ORD_O04 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ORD_O04_RESPONSE", "2.4"), false, false);
