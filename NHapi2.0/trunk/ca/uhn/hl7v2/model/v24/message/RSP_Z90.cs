...
/**
 * <p>Represents a RSP_Z90 message structure (see chapter 5). This structure contains the 
...
public class RSP_Z90 : AbstractMessage  {
	...
	/** 
	 * Creates a new RSP_Z90 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RSP_Z90_QUERY_RESPONSE", "2.4"), true, true);
