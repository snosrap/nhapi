...
/**
 * <p>Represents a RTB_K13 message structure (see chapter 5). This structure contains the 
...
public class RTB_K13 : AbstractMessage  {
	...
	/** 
	 * Creates a new RTB_K13 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RTB_K13_ROW_DEFINITION", "2.4"), false, false);
