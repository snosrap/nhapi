...
public class VXR_V03 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("VXR_V03_PATIENT_VISIT", "2.4"), false, false);
	      this.add(factory.getSegmentClass("GT1", "2.4"), false, true);
	      this.add(factory.getGroupClass("VXR_V03_INSURANCE", "2.4"), false, true);
	      this.add(factory.getGroupClass("VXR_V03_ORDER", "2.4"), false, true);
