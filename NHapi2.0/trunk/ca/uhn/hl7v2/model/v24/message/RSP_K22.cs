...
/**
 * <p>Represents a RSP_K22 message structure (see chapter 3). This structure contains the 
...
public class RSP_K22 : AbstractMessage  {
	...
	/** 
	 * Creates a new RSP_K22 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RSP_K22_QUERY_RESPONSE", "2.4"), false, true);
