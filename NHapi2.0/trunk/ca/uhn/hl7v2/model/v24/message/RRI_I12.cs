...
/**
 * <p>Represents a RRI_I12 message structure (see chapter 11). This structure contains the 
...
public class RRI_I12 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("RF1", "2.4"), false, false);
	      this.add(factory.getGroupClass("RRI_I12_AUTHORIZATION_CONTACT", "2.4"), false, false);
	      this.add(factory.getGroupClass("RRI_I12_PROVIDER_CONTACT", "2.4"), true, true);
	      this.add(factory.getSegmentClass("PID", "2.4"), true, false);
	      this.add(factory.getSegmentClass("ACC", "2.4"), false, false);
	      this.add(factory.getSegmentClass("DG1", "2.4"), false, true);
	      this.add(factory.getSegmentClass("DRG", "2.4"), false, true);
	      this.add(factory.getSegmentClass("AL1", "2.4"), false, true);
	      this.add(factory.getGroupClass("RRI_I12_PROCEDURE", "2.4"), false, true);
	      this.add(factory.getGroupClass("RRI_I12_OBSERVATION", "2.4"), false, true);
	      this.add(factory.getGroupClass("RRI_I12_PATIENT_VISIT", "2.4"), false, false);
