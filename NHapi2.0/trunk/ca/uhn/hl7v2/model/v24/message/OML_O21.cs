...
/**
 * <p>Represents a OML_O21 message structure (see chapter 4). This structure contains the 
...
public class OML_O21 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("OML_O21_PATIENT", "2.4"), false, false);
	      this.add(factory.getGroupClass("OML_O21_ORDER_GENERAL", "2.4"), true, true);
