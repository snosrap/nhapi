...
/**
 * <p>Represents a RRG_O16 message structure (see chapter 4). This structure contains the 
...
public class RRG_O16 : AbstractMessage  {
	...
	/** 
	 * Creates a new RRG_O16 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RRG_O16_RESPONSE", "2.4"), false, false);
