...
/**
 * <p>Represents the RGR_RGR_DEFINTION Group.  A Group is an ordered collection of message 
...
public class RGR_RGR_DEFINTION : AbstractGroup {
	...
	public RGR_RGR_DEFINTION(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RGR_RGR_PATIENT", "2.4"), false, false);
	      this.add(factory.getGroupClass("RGR_RGR_ORDER", "2.4"), true, true);
