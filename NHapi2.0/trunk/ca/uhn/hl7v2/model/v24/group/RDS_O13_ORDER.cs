...
public class RDS_O13_ORDER : AbstractGroup {
	...
	public RDS_O13_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RDS_O13_ORDER_DETAIL", "2.4"), false, false);
	      this.add(factory.getGroupClass("RDS_O13_ENCODING", "2.4"), false, false);
	      ...
	      this.add(factory.getGroupClass("RDS_O13_OBSERVATION", "2.4"), false, true);
