...
/**
 * <p>Represents the RRI_I12_PROVIDER_CONTACT Group.  A Group is an ordered collection of message 
...
public class RRI_I12_PROVIDER_CONTACT : AbstractGroup {
	...
	public RRI_I12_PROVIDER_CONTACT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("PRD", "2.4"), true, false);
	      this.add(factory.getSegmentClass("CTD", "2.4"), false, true);
