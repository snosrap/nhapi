...
public class BAR_P05_VISIT : AbstractGroup {
	...
	public BAR_P05_VISIT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("BAR_P05_PROCEDURE", "2.4"), false, true);
	      this.add(factory.getSegmentClass("GT1", "2.4"), false, true);
	      this.add(factory.getSegmentClass("NK1", "2.4"), false, true);
	      this.add(factory.getGroupClass("BAR_P05_INSURANCE", "2.4"), false, true);
	      this.add(factory.getSegmentClass("ACC", "2.4"), false, false);
	      this.add(factory.getSegmentClass("UB1", "2.4"), false, false);
	      this.add(factory.getSegmentClass("UB2", "2.4"), false, false);
	      this.add(factory.getSegmentClass("ABS", "2.4"), false, false);
	      this.add(factory.getSegmentClass("BLC", "2.4"), false, true);
	      this.add(factory.getSegmentClass("RMI", "2.4"), false, false);
