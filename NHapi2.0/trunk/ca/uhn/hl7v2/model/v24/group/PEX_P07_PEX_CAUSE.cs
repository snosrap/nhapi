...
public class PEX_P07_PEX_CAUSE : AbstractGroup {
	...
	public PEX_P07_PEX_CAUSE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("PCR", "2.4"), true, false);
	      this.add(factory.getGroupClass("PEX_P07_RX_ORDER", "2.4"), false, false);
	      this.add(factory.getGroupClass("PEX_P07_RX_ADMINISTRATION", "2.4"), false, true);
	      this.add(factory.getSegmentClass("PRB", "2.4"), false, true);
	      this.add(factory.getSegmentClass("OBX", "2.4"), false, true);
	      this.add(factory.getSegmentClass("NTE", "2.4"), false, true);
	      this.add(factory.getGroupClass("PEX_P07_ASSOCIATED_PERSON", "2.4"), false, false);
	      this.add(factory.getGroupClass("PEX_P07_STUDY", "2.4"), false, true);
