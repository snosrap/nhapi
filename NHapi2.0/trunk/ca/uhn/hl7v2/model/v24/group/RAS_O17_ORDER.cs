...
public class RAS_O17_ORDER : AbstractGroup {
	...
	public RAS_O17_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RAS_O17_ORDER_DETAIL", "2.4"), false, false);
	      this.add(factory.getGroupClass("RAS_O17_ENCODING", "2.4"), false, false);
	      this.add(factory.getSegmentClass("RXA", "2.4"), true, true);
	      this.add(factory.getSegmentClass("RXR", "2.4"), true, false);
	      this.add(factory.getGroupClass("RAS_O17_OBSERVATION", "2.4"), false, true);
