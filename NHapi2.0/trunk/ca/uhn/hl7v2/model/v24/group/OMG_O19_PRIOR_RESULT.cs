...
public class OMG_O19_PRIOR_RESULT : AbstractGroup {
	...
	public OMG_O19_PRIOR_RESULT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getGroupClass("OMG_O19_PATIENT_PRIOR", "2.4"), false, false);
	      this.add(factory.getGroupClass("OMG_O19_PATIENT_VISIT_PRIOR", "2.4"), false, false);
	      this.add(factory.getSegmentClass("AL1", "2.4"), false, true);
	      this.add(factory.getGroupClass("OMG_O19_ORDER_PRIOR", "2.4"), true, true);
