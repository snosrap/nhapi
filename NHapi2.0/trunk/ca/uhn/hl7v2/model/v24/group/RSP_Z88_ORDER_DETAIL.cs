...
/**
 * <p>Represents the RSP_Z88_ORDER_DETAIL Group.  A Group is an ordered collection of message 
...
public class RSP_Z88_ORDER_DETAIL : AbstractGroup {
	...
	public RSP_Z88_ORDER_DETAIL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RSP_Z88_COMPONENT", "2.4"), false, false);
