...
public class RSP_Z82_COMMON_ORDER : AbstractGroup {
	...
	public RSP_Z82_COMMON_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RSP_Z82_ORDER_DETAIL", "2.4"), false, false);
	      this.add(factory.getGroupClass("RSP_Z82_ENCODED_ORDER", "2.4"), false, false);
	      ...
	      this.add(factory.getGroupClass("RSP_Z82_OBSERVATION", "2.4"), true, true);
