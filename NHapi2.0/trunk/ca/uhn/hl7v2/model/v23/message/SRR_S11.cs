...
/**
 * <p>Represents a SRR_S11 message structure (see chapter [AAA]). This structure contains the 
...
public class SRR_S11 : AbstractMessage  {
	 ...
	 */
	public SRR_S11(ModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("SRR_S11_SCHEDULE", "2.3"), false, false);
...
get{
	   ...
	   try {
	      ret = (SRR_S11_SCHEDULE)this.get_Renamed("SCHEDULE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
