...
/**
 * <p>Represents a SRM_S09 message structure (see chapter [AAA]). This structure contains the 
...
public class SRM_S09 : AbstractMessage  {
	 ...
	 */
	public SRM_S09(ModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("SRM_S09_PATIENT", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRM_S09_RESOURCES", "2.3"), true, true);
...
{ 
	...
	public SRM_S09_PATIENT  getPATIENT() { 
	   ...
	   try {
	      ret = (SRM_S09_PATIENT)this.get_Renamed("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRM_S09_PATIENT getPATIENT(int rep) { 
	   return (SRM_S09_PATIENT)this.get_Renamed("PATIENT", rep);
	}
...
{ 
	...
	public SRM_S09_RESOURCES  getRESOURCES() { 
	   ...
	   try {
	      ret = (SRM_S09_RESOURCES)this.get_Renamed("RESOURCES");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRM_S09_RESOURCES getRESOURCES(int rep) { 
	   return (SRM_S09_RESOURCES)this.get_Renamed("RESOURCES", rep);
	}
