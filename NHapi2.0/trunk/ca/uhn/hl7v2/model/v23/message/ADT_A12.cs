...
/**
 * <p>Represents a ADT_A12 message structure (see chapter [AAA]). This structure contains the 
 ...
 * 8: DG1 (Diagnosis) <b>optional </b><br>
 */
...
public class ADT_A12 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("DG1", "2.3"), false, false);
