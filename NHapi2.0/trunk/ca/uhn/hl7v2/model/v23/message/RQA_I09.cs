...
/**
 * <p>Represents a RQA_I09 message structure (see chapter [AAA]). This structure contains the 
 * following elements: </p>
 * 0: MSH (Message header segment) <b></b><br>
 * 1: RF1 (Referral Information Segment) <b>optional </b><br>
 * 2: RQA_I09_AUTHORIZATION (a Group object) <b>optional </b><br>
 * 3: RQA_I09_PROVIDER (a Group object) <b>repeating</b><br>
 * 4: PID (Patient Identification) <b></b><br>
 * 5: NK1 (Next of kin) <b>optional repeating</b><br>
 * 6: RQA_I09_GUARANTOR_INSURANCE (a Group object) <b>optional </b><br>
 ...
 * 11: RQA_I09_PROCEDURE (a Group object) <b>optional repeating</b><br>
 * 12: RQA_I09_RESULTS (a Group object) <b>optional repeating</b><br>
 * 13: RQA_I09_VISIT (a Group object) <b>optional </b><br>
...
public class RQA_I09 : AbstractMessage  {
	...
	/** 
	 * Creates a new RQA_I09 Group with custom ModelClassFactory.
	 */
	public RQA_I09(ModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RQA_I09_PROVIDER", "2.3"), true, true);
	      this.add(factory.getSegmentClass("PID", "2.3"), true, false);
	      this.add(factory.getSegmentClass("NK1", "2.3"), false, true);
	      this.add(factory.getGroupClass("RQA_I09_GUARANTOR_INSURANCE", "2.3"), false, false);
	      ...
	      this.add(factory.getGroupClass("RQA_I09_PROCEDURE", "2.3"), false, true);
	      this.add(factory.getGroupClass("RQA_I09_RESULTS", "2.3"), false, true);
	      this.add(factory.getGroupClass("RQA_I09_VISIT", "2.3"), false, false);
...
get{
	...
	public RQA_I09_PROVIDER  getPROVIDER() { 
	   ...
	   try {
	      ret = (RQA_I09_PROVIDER)this.get_Renamed("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RQA_I09_PROVIDER getPROVIDER(int rep) { 
	   return (RQA_I09_PROVIDER)this.get_Renamed("PROVIDER", rep);
	}
...
get{
	   ...
	   try {
	      ret = (RQA_I09_GUARANTOR_INSURANCE)this.get_Renamed("GUARANTOR_INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
{ 
	...
	public RQA_I09_PROCEDURE  getPROCEDURE() { 
	   ...
	   try {
	      ret = (RQA_I09_PROCEDURE)this.get_Renamed("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RQA_I09_PROCEDURE getPROCEDURE(int rep) { 
	   return (RQA_I09_PROCEDURE)this.get_Renamed("PROCEDURE", rep);
	}
...
{ 
	...
	public RQA_I09_RESULTS  getRESULTS() { 
	   ...
	   try {
	      ret = (RQA_I09_RESULTS)this.get_Renamed("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RQA_I09_RESULTS getRESULTS(int rep) { 
	   return (RQA_I09_RESULTS)this.get_Renamed("RESULTS", rep);
	}
...
get{
	   ...
	   try {
	      ret = (RQA_I09_VISIT)this.get_Renamed("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
