...
/**
 * <p>Represents a RQA_I08 message structure (see chapter [AAA]). This structure contains the 
...
public class RQA_I08 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RQA_I08_AUTHORIZATION", "2.3"), false, false);
	      this.add(factory.getGroupClass("RQA_I08_PROVIDER", "2.3"), true, true);
	      this.add(factory.getSegmentClass("PID", "2.3"), true, false);
	      this.add(factory.getSegmentClass("NK1", "2.3"), false, true);
	      this.add(factory.getGroupClass("RQA_I08_GUARANTOR_INSURANCE", "2.3"), false, false);
	      ...
	      this.add(factory.getGroupClass("RQA_I08_PROCEDURE", "2.3"), false, true);
	      this.add(factory.getGroupClass("RQA_I08_OBSERVATION", "2.3"), false, true);
	      this.add(factory.getGroupClass("RQA_I08_VISIT", "2.3"), false, false);
