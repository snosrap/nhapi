...
/**
 * <p>Represents a PGL_PC6 message structure (see chapter [AAA]). This structure contains the 
...
public class PGL_PC6 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("PGL_PC6_PATIENT_VISIT", "2.3"), false, false);
	      this.add(factory.getGroupClass("PGL_PC6_GOAL", "2.3"), true, true);
