...
/**
 * <p>Represents a PPP_PCB message structure (see chapter [AAA]). This structure contains the 
...
public class PPP_PCB : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("PPP_PCB_PATIENT_VISIT", "2.3"), false, false);
	      this.add(factory.getGroupClass("PPP_PCB_PATHWAY", "2.3"), true, true);
