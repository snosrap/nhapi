...
public class RQA_I10 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RQA_I10_PROVIDER", "2.3"), true, true);
	      this.add(factory.getSegmentClass("PID", "2.3"), true, false);
	      this.add(factory.getSegmentClass("NK1", "2.3"), false, true);
	      this.add(factory.getGroupClass("RQA_I10_GUARANTOR_INSURANCE", "2.3"), false, false);
	      ...
	      this.add(factory.getGroupClass("RQA_I10_PROCEDURE", "2.3"), false, true);
	      this.add(factory.getGroupClass("RQA_I10_RESULTS", "2.3"), false, true);
	      this.add(factory.getGroupClass("RQA_I10_VISIT", "2.3"), false, false);
