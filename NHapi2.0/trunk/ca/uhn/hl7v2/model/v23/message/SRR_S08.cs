...
/**
 * <p>Represents a SRR_S08 message structure (see chapter [AAA]). This structure contains the 
 * following elements: </p>
 * 0: MSH (Message header segment) <b></b><br>
 * 1: MSA (Message acknowledgement segment) <b></b><br>
 * 2: ERR (Error segment) <b>optional </b><br>
 * 3: SRR_S08_SCHEDULE (a Group object) <b>optional </b><br>
 */
...
public class SRR_S08 : AbstractMessage  {
	...
	/** 
	 * Creates a new SRR_S08 Group with custom ModelClassFactory.
	 */
	public SRR_S08(ModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("SRR_S08_SCHEDULE", "2.3"), false, false);
...
get{
	   ...
	   try {
	      ret = (SRR_S08_SCHEDULE)this.get_Renamed("SCHEDULE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
