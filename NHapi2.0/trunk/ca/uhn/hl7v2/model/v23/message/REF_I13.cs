...
public class REF_I13 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("REF_I13_AUTHORIZATION", "2.3"), false, false);
	      this.add(factory.getGroupClass("REF_I13_PROVIDER", "2.3"), true, true);
	      ...
	      this.add(factory.getGroupClass("REF_I13_INSURANCE", "2.3"), false, true);
	      ...
	      this.add(factory.getGroupClass("REF_I13_PROCEDURE", "2.3"), false, true);
	      this.add(factory.getGroupClass("REF_I13_RESULTS", "2.3"), false, true);
	      this.add(factory.getGroupClass("REF_I13_VISIT", "2.3"), false, false);
