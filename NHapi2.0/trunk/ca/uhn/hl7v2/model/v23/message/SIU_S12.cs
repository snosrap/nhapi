...
/**
 * <p>Represents a SIU_S12 message structure (see chapter [AAA]). This structure contains the 
...
public class SIU_S12 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("SIU_S12_PATIENT", "2.3"), false, true);
	      this.add(factory.getGroupClass("SIU_S12_RESOURCES", "2.3"), true, true);
