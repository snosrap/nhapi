...
/**
 * <p>Represents a RPA_I08 message structure (see chapter [AAA]). This structure contains the 
...
public class RPA_I08 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RPA_I08_AUTHORIZATION", "2.3"), false, false);
	      this.add(factory.getGroupClass("RPA_I08_PROVIDER", "2.3"), true, true);
	      ...
	      this.add(factory.getGroupClass("RPA_I08_INSURANCE", "2.3"), false, true);
	      ...
	      this.add(factory.getGroupClass("RPA_I08_PROCEDURE", "2.3"), true, true);
	      this.add(factory.getGroupClass("RPA_I08_OBSERVATION", "2.3"), false, true);
	      this.add(factory.getGroupClass("RPA_I08_VISIT", "2.3"), false, false);
