...
/**
 * <p>Represents a RCL_I06 message structure (see chapter [AAA]). This structure contains the 
 ...
 * 9: NTE (Notes and comments segment) <b>optional repeating</b><br>
 * 10: DSP (Display data segment) <b>optional repeating</b><br>
 * 11: DSC (Continuation pointer segment) <b>optional </b><br>
 */
...
public class RCL_I06 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RCL_I06_PROVIDER", "2.3"), true, true);
