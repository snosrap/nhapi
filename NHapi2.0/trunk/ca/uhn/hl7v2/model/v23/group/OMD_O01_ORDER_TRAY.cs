...
/**
 * <p>Represents the OMD_O01_ORDER_TRAY Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: ORC (Common order segment) <b></b><br>
 * 1: ODT (Diet tray instructions segment) <b>repeating</b><br>
...
public class OMD_O01_ORDER_TRAY : AbstractGroup {
	 ...
	 */
	public OMD_O01_ORDER_TRAY(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("ORC", "2.3"), true, false);
	      this.add(factory.getSegmentClass("ODT", "2.3"), true, true);
