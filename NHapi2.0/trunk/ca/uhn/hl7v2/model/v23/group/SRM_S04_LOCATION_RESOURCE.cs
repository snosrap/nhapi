...
/**
 * <p>Represents the SRM_S04_LOCATION_RESOURCE Group.  A Group is an ordered collection of message 
...
public class SRM_S04_LOCATION_RESOURCE : AbstractGroup {
	 ...
	 */
	public SRM_S04_LOCATION_RESOURCE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
