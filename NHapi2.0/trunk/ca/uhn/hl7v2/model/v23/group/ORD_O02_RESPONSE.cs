...
public class ORD_O02_RESPONSE : AbstractGroup {
	...
	public ORD_O02_RESPONSE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getGroupClass("ORD_O02_PATIENT", "2.3"), false, false);
	      this.add(factory.getGroupClass("ORD_O02_ORDER_DIET", "2.3"), true, true);
	      this.add(factory.getGroupClass("ORD_O02_ORDER_TRAY", "2.3"), false, true);
