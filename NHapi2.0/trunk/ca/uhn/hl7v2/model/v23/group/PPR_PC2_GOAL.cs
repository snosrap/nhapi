...
/**
 * <p>Represents the PPR_PC2_GOAL Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: GOL (Goal Detail) <b></b><br>
 * 1: NTE (Notes and comments segment) <b>optional repeating</b><br>
 * 2: VAR (Variance) <b>optional repeating</b><br>
 * 3: PPR_PC2_GOAL_ROLE (a Group object) <b>optional repeating</b><br>
 * 4: PPR_PC2_GOAL_OBSERVATION (a Group object) <b>optional repeating</b><br>
 */
...
public class PPR_PC2_GOAL : AbstractGroup {
	 ...
	 */
	public PPR_PC2_GOAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPR_PC2_GOAL_ROLE", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPR_PC2_GOAL_OBSERVATION", "2.3"), false, true);
...
{ 
	...
	public PPR_PC2_GOAL_ROLE  getGOAL_ROLE() { 
	   ...
	   try {
	      ret = (PPR_PC2_GOAL_ROLE)this.get_Renamed("GOAL_ROLE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPR_PC2_GOAL_ROLE getGOAL_ROLE(int rep) { 
	   return (PPR_PC2_GOAL_ROLE)this.get_Renamed("GOAL_ROLE", rep);
	}
...
{ 
	...
	public PPR_PC2_GOAL_OBSERVATION  getGOAL_OBSERVATION() { 
	   ...
	   try {
	      ret = (PPR_PC2_GOAL_OBSERVATION)this.get_Renamed("GOAL_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPR_PC2_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep) { 
	   return (PPR_PC2_GOAL_OBSERVATION)this.get_Renamed("GOAL_OBSERVATION", rep);
	}
