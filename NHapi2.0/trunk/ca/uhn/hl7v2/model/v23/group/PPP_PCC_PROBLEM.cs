...
public class PPP_PCC_PROBLEM : AbstractGroup {
	 ...
	 */
	public PPP_PCC_PROBLEM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPP_PCC_PROBLEM_ROLE", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPP_PCC_PROBLEM_OBSERVATION", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPP_PCC_GOAL", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPP_PCC_ORDER", "2.3"), false, true);
...
{ 
	...
	public PPP_PCC_PROBLEM_ROLE  getPROBLEM_ROLE() { 
	   ...
	   try {
	      ret = (PPP_PCC_PROBLEM_ROLE)this.get_Renamed("PROBLEM_ROLE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPP_PCC_PROBLEM_ROLE getPROBLEM_ROLE(int rep) { 
	   return (PPP_PCC_PROBLEM_ROLE)this.get_Renamed("PROBLEM_ROLE", rep);
	}
...
{ 
	...
	public PPP_PCC_PROBLEM_OBSERVATION  getPROBLEM_OBSERVATION() { 
	   ...
	   try {
	      ret = (PPP_PCC_PROBLEM_OBSERVATION)this.get_Renamed("PROBLEM_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPP_PCC_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) { 
	   return (PPP_PCC_PROBLEM_OBSERVATION)this.get_Renamed("PROBLEM_OBSERVATION", rep);
	}
...
{ 
	...
	public PPP_PCC_GOAL  getGOAL() { 
	   ...
	   try {
	      ret = (PPP_PCC_GOAL)this.get_Renamed("GOAL");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPP_PCC_GOAL getGOAL(int rep) { 
	   return (PPP_PCC_GOAL)this.get_Renamed("GOAL", rep);
	}
...
{ 
	...
	public PPP_PCC_ORDER  getORDER() { 
	   ...
	   try {
	      ret = (PPP_PCC_ORDER)this.get_Renamed("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPP_PCC_ORDER getORDER(int rep) { 
	   return (PPP_PCC_ORDER)this.get_Renamed("ORDER", rep);
	}
