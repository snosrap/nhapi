...
/**
 * <p>Represents the PGL_PC6_ORDER_DETAIL Group.  A Group is an ordered collection of message 
 ...
 * 3: PGL_PC6_ORDER_OBSERVATION (a Group object) <b>optional repeating</b><br>
 */
...
public class PGL_PC6_ORDER_DETAIL : AbstractGroup {
	...
	public PGL_PC6_ORDER_DETAIL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PGL_PC6_ORDER_OBSERVATION", "2.3"), false, true);
