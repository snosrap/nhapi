...
/**
 * <p>Represents the PGL_PC8_GOAL Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: GOL (Goal Detail) <b></b><br>
 * 1: NTE (Notes and comments segment) <b>optional repeating</b><br>
 * 2: VAR (Variance) <b>optional repeating</b><br>
 * 3: PGL_PC8_GOAL_ROLE (a Group object) <b>optional repeating</b><br>
 * 4: PGL_PC8_PATHWAY (a Group object) <b>optional repeating</b><br>
 * 5: PGL_PC8_OBSERVATION (a Group object) <b>optional repeating</b><br>
 * 6: PGL_PC8_PROBLEM (a Group object) <b>optional repeating</b><br>
 * 7: PGL_PC8_ORDER (a Group object) <b>optional repeating</b><br>
 */
...
public class PGL_PC8_GOAL : AbstractGroup {
	 ...
	 */
	public PGL_PC8_GOAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PGL_PC8_GOAL_ROLE", "2.3"), false, true);
	      this.add(factory.getGroupClass("PGL_PC8_PATHWAY", "2.3"), false, true);
	      this.add(factory.getGroupClass("PGL_PC8_OBSERVATION", "2.3"), false, true);
	      this.add(factory.getGroupClass("PGL_PC8_PROBLEM", "2.3"), false, true);
	      this.add(factory.getGroupClass("PGL_PC8_ORDER", "2.3"), false, true);
...
{ 
	...
	public PGL_PC8_GOAL_ROLE  getGOAL_ROLE() { 
	   ...
	   try {
	      ret = (PGL_PC8_GOAL_ROLE)this.get_Renamed("GOAL_ROLE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PGL_PC8_GOAL_ROLE getGOAL_ROLE(int rep) { 
	   return (PGL_PC8_GOAL_ROLE)this.get_Renamed("GOAL_ROLE", rep);
	}
...
{ 
	...
	public PGL_PC8_PATHWAY  getPATHWAY() { 
	   ...
	   try {
	      ret = (PGL_PC8_PATHWAY)this.get_Renamed("PATHWAY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PGL_PC8_PATHWAY getPATHWAY(int rep) { 
	   return (PGL_PC8_PATHWAY)this.get_Renamed("PATHWAY", rep);
	}
...
{ 
	...
	public PGL_PC8_OBSERVATION  getOBSERVATION() { 
	   ...
	   try {
	      ret = (PGL_PC8_OBSERVATION)this.get_Renamed("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PGL_PC8_OBSERVATION getOBSERVATION(int rep) { 
	   return (PGL_PC8_OBSERVATION)this.get_Renamed("OBSERVATION", rep);
	}
...
{ 
	...
	public PGL_PC8_PROBLEM  getPROBLEM() { 
	   ...
	   try {
	      ret = (PGL_PC8_PROBLEM)this.get_Renamed("PROBLEM");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PGL_PC8_PROBLEM getPROBLEM(int rep) { 
	   return (PGL_PC8_PROBLEM)this.get_Renamed("PROBLEM", rep);
	}
...
{ 
	...
	public PGL_PC8_ORDER  getORDER() { 
	   ...
	   try {
	      ret = (PGL_PC8_ORDER)this.get_Renamed("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PGL_PC8_ORDER getORDER(int rep) { 
	   return (PGL_PC8_ORDER)this.get_Renamed("ORDER", rep);
	}
