...
/**
 * <p>Represents the PTR_PCF_ORDER_DETAIL Group.  A Group is an ordered collection of message 
 ...
 * 3: PTR_PCF_ORDER_OBSERVATION (a Group object) <b>optional repeating</b><br>
 */
...
public class PTR_PCF_ORDER_DETAIL : AbstractGroup {
	...
	public PTR_PCF_ORDER_DETAIL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PTR_PCF_ORDER_OBSERVATION", "2.3"), false, true);
