...
public class SIU_S20_RESOURCES : AbstractGroup {
	...
	public SIU_S20_RESOURCES(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("SIU_S20_SERVICE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SIU_S20_GENERAL_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SIU_S20_LOCATION_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SIU_S20_PERSONNEL_RESOURCE", "2.3"), false, true);
