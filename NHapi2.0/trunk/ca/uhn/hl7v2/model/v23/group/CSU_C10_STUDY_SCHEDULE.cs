...
public class CSU_C10_STUDY_SCHEDULE : AbstractGroup {
	 ...
	 */
	public CSU_C10_STUDY_SCHEDULE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("CSS", "2.3"), false, false);
	      this.add(factory.getGroupClass("CSU_C10_STUDY_OBSERVATION", "2.3"), false, true);
	      this.add(factory.getGroupClass("CSU_C10_STUDY_PHARM", "2.3"), true, true);
...
get{
	...
	public CSU_C10_STUDY_OBSERVATION  getSTUDY_OBSERVATION() { 
	   ...
	   try {
	      ret = (CSU_C10_STUDY_OBSERVATION)this.get_Renamed("STUDY_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public CSU_C10_STUDY_OBSERVATION getSTUDY_OBSERVATION(int rep) { 
	   return (CSU_C10_STUDY_OBSERVATION)this.get_Renamed("STUDY_OBSERVATION", rep);
	}
...
{ 
	...
	public CSU_C10_STUDY_PHARM  getSTUDY_PHARM() { 
	   ...
	   try {
	      ret = (CSU_C10_STUDY_PHARM)this.get_Renamed("STUDY_PHARM");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public CSU_C10_STUDY_PHARM getSTUDY_PHARM(int rep) { 
	   return (CSU_C10_STUDY_PHARM)this.get_Renamed("STUDY_PHARM", rep);
	}
