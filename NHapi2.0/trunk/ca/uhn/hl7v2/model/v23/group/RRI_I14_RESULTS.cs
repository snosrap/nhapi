...
/**
 * <p>Represents the RRI_I14_RESULTS Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: OBR (Observation request segment) <b></b><br>
 * 1: NTE (Notes and comments segment) <b>optional repeating</b><br>
 * 2: RRI_I14_OBSERVATION (a Group object) <b>optional repeating</b><br>
 */
...
public class RRI_I14_RESULTS : AbstractGroup {
	 ...
	 */
	public RRI_I14_RESULTS(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("OBR", "2.3"), true, false);
	      this.add(factory.getSegmentClass("NTE", "2.3"), false, true);
	      this.add(factory.getGroupClass("RRI_I14_OBSERVATION", "2.3"), false, true);
...
{ 
	...
	public RRI_I14_OBSERVATION  getOBSERVATION() { 
	   ...
	   try {
	      ret = (RRI_I14_OBSERVATION)this.get_Renamed("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RRI_I14_OBSERVATION getOBSERVATION(int rep) { 
	   return (RRI_I14_OBSERVATION)this.get_Renamed("OBSERVATION", rep);
	}
