...
/**
 * <p>Represents the ARD_A19_QUERY_RESPONSE Group.  A Group is an ordered collection of message 
 ...
 * 11: ARD_A19_PROCEDURE (a Group object) <b>optional repeating</b><br>
 * 12: GT1 (Guarantor) <b>optional repeating</b><br>
 * 13: ARD_A19_INSURANCE (a Group object) <b>optional repeating</b><br>
 * 14: ACC (Accident) <b>optional </b><br>
 * 15: UB1 (UB82  data) <b>optional </b><br>
 * 16: UB2 (UB92 data) <b>optional </b><br>
 */
...
public class ARD_A19_QUERY_RESPONSE : AbstractGroup {
	 ...
	 */
	public ARD_A19_QUERY_RESPONSE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("EVN", "2.3"), false, false);
	      ...
	      this.add(factory.getGroupClass("ARD_A19_PROCEDURE", "2.3"), false, true);
	      this.add(factory.getSegmentClass("GT1", "2.3"), false, true);
	      this.add(factory.getGroupClass("ARD_A19_INSURANCE", "2.3"), false, true);
...
get{
	...
	public ARD_A19_PROCEDURE  getPROCEDURE() { 
	   ...
	   try {
	      ret = (ARD_A19_PROCEDURE)this.get_Renamed("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public ARD_A19_PROCEDURE getPROCEDURE(int rep) { 
	   return (ARD_A19_PROCEDURE)this.get_Renamed("PROCEDURE", rep);
	}
...
{ 
	...
	public ARD_A19_INSURANCE  getINSURANCE() { 
	   ...
	   try {
	      ret = (ARD_A19_INSURANCE)this.get_Renamed("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public ARD_A19_INSURANCE getINSURANCE(int rep) { 
	   return (ARD_A19_INSURANCE)this.get_Renamed("INSURANCE", rep);
	}
