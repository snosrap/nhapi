...
/**
 * <p>Represents the SRR_S08_SCHEDULE Group.  A Group is an ordered collection of message 
 ...
 * 2: SRR_S08_PATIENT (a Group object) <b>optional repeating</b><br>
 * 3: SRR_S08_RESOURCES (a Group object) <b>repeating</b><br>
 */
...
public class SRR_S08_SCHEDULE : AbstractGroup {
	 ...
	 */
	public SRR_S08_SCHEDULE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("SCH", "2.3"), true, false);
	      this.add(factory.getSegmentClass("NTE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRR_S08_PATIENT", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRR_S08_RESOURCES", "2.3"), true, true);
...
{ 
	...
	public SRR_S08_PATIENT  getPATIENT() { 
	   ...
	   try {
	      ret = (SRR_S08_PATIENT)this.get_Renamed("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRR_S08_PATIENT getPATIENT(int rep) { 
	   return (SRR_S08_PATIENT)this.get_Renamed("PATIENT", rep);
	}
...
{ 
	...
	public SRR_S08_RESOURCES  getRESOURCES() { 
	   ...
	   try {
	      ret = (SRR_S08_RESOURCES)this.get_Renamed("RESOURCES");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRR_S08_RESOURCES getRESOURCES(int rep) { 
	   return (SRR_S08_RESOURCES)this.get_Renamed("RESOURCES", rep);
	}
