...
/**
 * <p>Represents the SRR_S10_RESOURCES Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: RGS (Resource Group) <b></b><br>
 * 1: SRR_S10_SERVICE (a Group object) <b>optional repeating</b><br>
 * 2: SRR_S10_GENERAL_RESOURCE (a Group object) <b>optional repeating</b><br>
 * 3: SRR_S10_LOCATION_RESOURCE (a Group object) <b>optional repeating</b><br>
 * 4: SRR_S10_PERSONNEL_RESOURCE (a Group object) <b>optional repeating</b><br>
 */
...
public class SRR_S10_RESOURCES : AbstractGroup {
	 ...
	 */
	public SRR_S10_RESOURCES(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("RGS", "2.3"), true, false);
	      this.add(factory.getGroupClass("SRR_S10_SERVICE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRR_S10_GENERAL_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRR_S10_LOCATION_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRR_S10_PERSONNEL_RESOURCE", "2.3"), false, true);
...
get{
	...
	public SRR_S10_SERVICE  getSERVICE() { 
	   ...
	   try {
	      ret = (SRR_S10_SERVICE)this.get_Renamed("SERVICE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRR_S10_SERVICE getSERVICE(int rep) { 
	   return (SRR_S10_SERVICE)this.get_Renamed("SERVICE", rep);
	}
...
{ 
	...
	public SRR_S10_GENERAL_RESOURCE  getGENERAL_RESOURCE() { 
	   ...
	   try {
	      ret = (SRR_S10_GENERAL_RESOURCE)this.get_Renamed("GENERAL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRR_S10_GENERAL_RESOURCE getGENERAL_RESOURCE(int rep) { 
	   return (SRR_S10_GENERAL_RESOURCE)this.get_Renamed("GENERAL_RESOURCE", rep);
	}
...
{ 
	...
	public SRR_S10_LOCATION_RESOURCE  getLOCATION_RESOURCE() { 
	   ...
	   try {
	      ret = (SRR_S10_LOCATION_RESOURCE)this.get_Renamed("LOCATION_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRR_S10_LOCATION_RESOURCE getLOCATION_RESOURCE(int rep) { 
	   return (SRR_S10_LOCATION_RESOURCE)this.get_Renamed("LOCATION_RESOURCE", rep);
	}
...
{ 
	...
	public SRR_S10_PERSONNEL_RESOURCE  getPERSONNEL_RESOURCE() { 
	   ...
	   try {
	      ret = (SRR_S10_PERSONNEL_RESOURCE)this.get_Renamed("PERSONNEL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRR_S10_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE(int rep) { 
	   return (SRR_S10_PERSONNEL_RESOURCE)this.get_Renamed("PERSONNEL_RESOURCE", rep);
	}
