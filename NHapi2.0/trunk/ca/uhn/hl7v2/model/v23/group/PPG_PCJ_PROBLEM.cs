...
/**
 * <p>Represents the PPG_PCJ_PROBLEM Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: PRB (Problem Detail) <b></b><br>
 * 1: NTE (Notes and comments segment) <b>optional repeating</b><br>
 * 2: VAR (Variance) <b>optional repeating</b><br>
 * 3: PPG_PCJ_PROBLEM_ROLE (a Group object) <b>optional repeating</b><br>
 * 4: PPG_PCJ_PROBLEM_OBSERVATION (a Group object) <b>optional repeating</b><br>
 */
...
public class PPG_PCJ_PROBLEM : AbstractGroup {
	 ...
	 */
	public PPG_PCJ_PROBLEM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPG_PCJ_PROBLEM_ROLE", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPG_PCJ_PROBLEM_OBSERVATION", "2.3"), false, true);
...
{ 
	...
	public PPG_PCJ_PROBLEM_ROLE  getPROBLEM_ROLE() { 
	   ...
	   try {
	      ret = (PPG_PCJ_PROBLEM_ROLE)this.get_Renamed("PROBLEM_ROLE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPG_PCJ_PROBLEM_ROLE getPROBLEM_ROLE(int rep) { 
	   return (PPG_PCJ_PROBLEM_ROLE)this.get_Renamed("PROBLEM_ROLE", rep);
	}
...
{ 
	...
	public PPG_PCJ_PROBLEM_OBSERVATION  getPROBLEM_OBSERVATION() { 
	   ...
	   try {
	      ret = (PPG_PCJ_PROBLEM_OBSERVATION)this.get_Renamed("PROBLEM_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPG_PCJ_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) { 
	   return (PPG_PCJ_PROBLEM_OBSERVATION)this.get_Renamed("PROBLEM_OBSERVATION", rep);
	}
