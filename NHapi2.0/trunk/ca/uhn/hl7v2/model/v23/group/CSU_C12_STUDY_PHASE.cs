...
public class CSU_C12_STUDY_PHASE : AbstractGroup {
	 ...
	 */
	public CSU_C12_STUDY_PHASE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("CSP", "2.3"), false, false);
	      this.add(factory.getGroupClass("CSU_C12_STUDY_SCHEDULE", "2.3"), true, true);
...
get{
	...
	public CSU_C12_STUDY_SCHEDULE  getSTUDY_SCHEDULE() { 
	   ...
	   try {
	      ret = (CSU_C12_STUDY_SCHEDULE)this.get_Renamed("STUDY_SCHEDULE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public CSU_C12_STUDY_SCHEDULE getSTUDY_SCHEDULE(int rep) { 
	   return (CSU_C12_STUDY_SCHEDULE)this.get_Renamed("STUDY_SCHEDULE", rep);
	}
