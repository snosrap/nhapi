...
/**
 * <p>Represents the RQA_I10_GUARANTOR_INSURANCE Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: GT1 (Guarantor) <b>optional repeating</b><br>
 * 1: RQA_I10_INSURANCE (a Group object) <b>repeating</b><br>
 */
...
public class RQA_I10_GUARANTOR_INSURANCE : AbstractGroup {
	 ...
	 */
	public RQA_I10_GUARANTOR_INSURANCE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("GT1", "2.3"), false, true);
	      this.add(factory.getGroupClass("RQA_I10_INSURANCE", "2.3"), true, true);
...
{ 
	...
	public RQA_I10_INSURANCE  getINSURANCE() { 
	   ...
	   try {
	      ret = (RQA_I10_INSURANCE)this.get_Renamed("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RQA_I10_INSURANCE getINSURANCE(int rep) { 
	   return (RQA_I10_INSURANCE)this.get_Renamed("INSURANCE", rep);
	}
