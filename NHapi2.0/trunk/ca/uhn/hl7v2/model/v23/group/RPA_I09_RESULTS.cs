...
/**
 * <p>Represents the RPA_I09_RESULTS Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: OBR (Observation request segment) <b></b><br>
 * 1: NTE (Notes and comments segment) <b>optional repeating</b><br>
 * 2: RPA_I09_OBSERVATION (a Group object) <b>optional repeating</b><br>
 */
...
public class RPA_I09_RESULTS : AbstractGroup {
	 ...
	 */
	public RPA_I09_RESULTS(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("OBR", "2.3"), true, false);
	      this.add(factory.getSegmentClass("NTE", "2.3"), false, true);
	      this.add(factory.getGroupClass("RPA_I09_OBSERVATION", "2.3"), false, true);
...
{ 
	...
	public RPA_I09_OBSERVATION  getOBSERVATION() { 
	   ...
	   try {
	      ret = (RPA_I09_OBSERVATION)this.get_Renamed("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RPA_I09_OBSERVATION getOBSERVATION(int rep) { 
	   return (RPA_I09_OBSERVATION)this.get_Renamed("OBSERVATION", rep);
	}
