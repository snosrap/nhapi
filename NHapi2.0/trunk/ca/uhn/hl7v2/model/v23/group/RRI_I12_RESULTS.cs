...
/**
 * <p>Represents the RRI_I12_RESULTS Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: OBR (Observation request segment) <b></b><br>
 * 1: NTE (Notes and comments segment) <b>optional repeating</b><br>
 * 2: RRI_I12_OBSERVATION (a Group object) <b>optional repeating</b><br>
 */
...
public class RRI_I12_RESULTS : AbstractGroup {
	 ...
	 */
	public RRI_I12_RESULTS(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("OBR", "2.3"), true, false);
	      this.add(factory.getSegmentClass("NTE", "2.3"), false, true);
	      this.add(factory.getGroupClass("RRI_I12_OBSERVATION", "2.3"), false, true);
