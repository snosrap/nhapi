...
/**
 * <p>Represents the RQA_I11_RESULTS Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: OBR (Observation request segment) <b></b><br>
 * 1: NTE (Notes and comments segment) <b>optional repeating</b><br>
 * 2: RQA_I11_OBSERVATION (a Group object) <b>optional repeating</b><br>
 */
...
public class RQA_I11_RESULTS : AbstractGroup {
	 ...
	 */
	public RQA_I11_RESULTS(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("OBR", "2.3"), true, false);
	      this.add(factory.getSegmentClass("NTE", "2.3"), false, true);
	      this.add(factory.getGroupClass("RQA_I11_OBSERVATION", "2.3"), false, true);
...
{ 
	...
	public RQA_I11_OBSERVATION  getOBSERVATION() { 
	   ...
	   try {
	      ret = (RQA_I11_OBSERVATION)this.get_Renamed("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RQA_I11_OBSERVATION getOBSERVATION(int rep) { 
	   return (RQA_I11_OBSERVATION)this.get_Renamed("OBSERVATION", rep);
	}
