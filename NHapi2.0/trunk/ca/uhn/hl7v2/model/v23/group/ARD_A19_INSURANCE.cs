...
/**
 * <p>Represents the ARD_A19_INSURANCE Group.  A Group is an ordered collection of message 
...
public class ARD_A19_INSURANCE : AbstractGroup {
	 ...
	 */
	public ARD_A19_INSURANCE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
