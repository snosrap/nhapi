...
public class RAS_O01_ORDER : AbstractGroup {
	...
	public RAS_O01_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RAS_O01_ORDER_DETAIL", "2.3"), false, false);
	      this.add(factory.getGroupClass("RAS_O01_ENCODING", "2.3"), false, false);
	      this.add(factory.getSegmentClass("RXA", "2.3"), true, true);
	      this.add(factory.getSegmentClass("RXR", "2.3"), true, false);
	      this.add(factory.getGroupClass("RAS_O01_OBSERVATION", "2.3"), false, true);
