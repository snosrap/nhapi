...
public class SRM_S02_RESOURCES : AbstractGroup {
	...
	public SRM_S02_RESOURCES(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("SRM_S02_SERVICE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRM_S02_GENERAL_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRM_S02_LOCATION_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRM_S02_PERSONNEL_RESOURCE", "2.3"), false, true);
