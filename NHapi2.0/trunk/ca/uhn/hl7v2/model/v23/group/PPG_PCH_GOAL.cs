...
public class PPG_PCH_GOAL : AbstractGroup {
	 ...
	 */
	public PPG_PCH_GOAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPG_PCH_GOAL_ROLE", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPG_PCH_GOAL_OBSERVATION", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPG_PCH_PROBLEM", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPG_PCH_ORDER", "2.3"), false, true);
...
{ 
	...
	public PPG_PCH_GOAL_ROLE  getGOAL_ROLE() { 
	   ...
	   try {
	      ret = (PPG_PCH_GOAL_ROLE)this.get_Renamed("GOAL_ROLE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPG_PCH_GOAL_ROLE getGOAL_ROLE(int rep) { 
	   return (PPG_PCH_GOAL_ROLE)this.get_Renamed("GOAL_ROLE", rep);
	}
...
{ 
	...
	public PPG_PCH_GOAL_OBSERVATION  getGOAL_OBSERVATION() { 
	   ...
	   try {
	      ret = (PPG_PCH_GOAL_OBSERVATION)this.get_Renamed("GOAL_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPG_PCH_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep) { 
	   return (PPG_PCH_GOAL_OBSERVATION)this.get_Renamed("GOAL_OBSERVATION", rep);
	}
...
{ 
	...
	public PPG_PCH_PROBLEM  getPROBLEM() { 
	   ...
	   try {
	      ret = (PPG_PCH_PROBLEM)this.get_Renamed("PROBLEM");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPG_PCH_PROBLEM getPROBLEM(int rep) { 
	   return (PPG_PCH_PROBLEM)this.get_Renamed("PROBLEM", rep);
	}
...
{ 
	...
	public PPG_PCH_ORDER  getORDER() { 
	   ...
	   try {
	      ret = (PPG_PCH_ORDER)this.get_Renamed("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPG_PCH_ORDER getORDER(int rep) { 
	   return (PPG_PCH_ORDER)this.get_Renamed("ORDER", rep);
	}
