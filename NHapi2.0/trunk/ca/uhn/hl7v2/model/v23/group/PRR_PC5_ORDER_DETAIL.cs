...
/**
 * <p>Represents the PRR_PC5_ORDER_DETAIL Group.  A Group is an ordered collection of message 
 ...
 * 3: PRR_PC5_ORDER_OBSERVATION (a Group object) <b>optional repeating</b><br>
 */
...
public class PRR_PC5_ORDER_DETAIL : AbstractGroup {
	...
	public PRR_PC5_ORDER_DETAIL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PRR_PC5_ORDER_OBSERVATION", "2.3"), false, true);
