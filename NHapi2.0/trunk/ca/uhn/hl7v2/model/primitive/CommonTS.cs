...
namespace ca.uhn.hl7v2.model.primitive
{
	...
	public class CommonTS
	{
		...
		//UPGRADE_NOTE: The initialization of  'log' was moved to static method 'ca.uhn.hl7v2.model.primitive.CommonTS'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
