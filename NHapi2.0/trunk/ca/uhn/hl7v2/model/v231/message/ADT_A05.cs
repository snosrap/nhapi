...
/**
 * <p>Represents a ADT_A05 message structure (see chapter [AAA]). This structure contains the 
 ...
 * 12: ADT_A05_PROCEDURE (a Group object) <b>optional repeating</b><br>
 * 13: GT1 (GT1 - guarantor segment) <b>optional repeating</b><br>
 * 14: ADT_A05_INSURANCE (a Group object) <b>optional repeating</b><br>
...
public class ADT_A05 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ADT_A05_PROCEDURE", "2.3.1"), false, true);
	      this.add(factory.getSegmentClass("GT1", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("ADT_A05_INSURANCE", "2.3.1"), false, true);
