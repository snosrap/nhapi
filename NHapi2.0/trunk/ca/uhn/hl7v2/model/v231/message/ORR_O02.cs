...
/**
 * <p>Represents a ORR_O02 message structure (see chapter 4.2.2). This structure contains the 
...
public class ORR_O02 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ORR_O02_RESPONSE", "2.3.1"), false, false);
