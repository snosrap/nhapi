...
/**
 * <p>Represents a ORD_O02 message structure (see chapter 4.6). This structure contains the 
 ...
 * 4: ORD_O02_RESPONSE (a Group object) <b>optional </b><br>
 */
...
public class ORD_O02 : AbstractMessage  {
	...
	/** 
	 * Creates a new ORD_O02 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ORD_O02_RESPONSE", "2.3.1"), false, false);
...
get{
	   ...
	   try {
	      ret = (ORD_O02_RESPONSE)this.get_Renamed("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
