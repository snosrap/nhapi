...
/**
 * <p>Represents a RGR_RGR message structure (see chapter [AAA]). This structure contains the 
 * following elements: </p>
 * 0: MSH (MSH - message header segment) <b></b><br>
 * 1: MSA (MSA - message acknowledgment segment) <b></b><br>
 * 2: ERR (ERR - error segment) <b>optional </b><br>
 * 3: RGR_RGR_DEFINITION (a Group object) <b>repeating</b><br>
...
public class RGR_RGR : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RGR_RGR_DEFINITION", "2.3.1"), true, true);
