...
public class RPA_I08 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RPA_I08_PROVIDER", "2.3.1"), true, true);
	      ...
	      this.add(factory.getGroupClass("RPA_I08_INSURANCE", "2.3.1"), false, true);
	      ...
	      this.add(factory.getGroupClass("RPA_I08_PROCEDURE", "2.3.1"), true, true);
	      this.add(factory.getGroupClass("RPA_I08_OBSERVATION", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("RPA_I08_VISIT", "2.3.1"), false, false);
