...
/**
 * <p>Represents a ADT_A08 message structure (see chapter [AAA]). This structure contains the 
 ...
 * 12: ADT_A08_PROCEDURE (a Group object) <b>optional repeating</b><br>
 * 13: GT1 (GT1 - guarantor segment) <b>optional repeating</b><br>
 * 14: ADT_A08_INSURANCE (a Group object) <b>optional repeating</b><br>
...
public class ADT_A08 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ADT_A08_PROCEDURE", "2.3.1"), false, true);
	      this.add(factory.getSegmentClass("GT1", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("ADT_A08_INSURANCE", "2.3.1"), false, true);
...
get{
	...
	public ADT_A08_PROCEDURE  getPROCEDURE() { 
	   ...
	   try {
	      ret = (ADT_A08_PROCEDURE)this.get_Renamed("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public ADT_A08_PROCEDURE getPROCEDURE(int rep) { 
	   return (ADT_A08_PROCEDURE)this.get_Renamed("PROCEDURE", rep);
	}
