...
/**
 * <p>Represents a PPG_PCG message structure (see chapter ). This structure contains the 
...
public class PPG_PCG : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("PPG_PCG_PATIENT_VISIT", "2.3.1"), false, false);
	      this.add(factory.getGroupClass("PPG_PCG_PATHWAY", "2.3.1"), true, true);
