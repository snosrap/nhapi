...
/**
 * <p>Represents a ADT_A07 message structure (see chapter [AAA]). This structure contains the 
 ...
 * 13: ADT_A07_PROCEDURE (a Group object) <b>optional repeating</b><br>
 * 14: GT1 (GT1 - guarantor segment) <b>optional repeating</b><br>
 * 15: ADT_A07_INSURANCE (a Group object) <b>optional repeating</b><br>
...
public class ADT_A07 : AbstractMessage  {
	...
	/** 
	 * Creates a new ADT_A07 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("MRG", "2.3.1"), false, false);
	      ...
	      this.add(factory.getGroupClass("ADT_A07_PROCEDURE", "2.3.1"), false, true);
	      this.add(factory.getSegmentClass("GT1", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("ADT_A07_INSURANCE", "2.3.1"), false, true);
	      this.add(factory.getSegmentClass("ACC", "2.3.1"), false, false);
	      this.add(factory.getSegmentClass("UB1", "2.3.1"), false, false);
	      this.add(factory.getSegmentClass("UB2", "2.3.1"), false, false);
...
get{
	...
	public ADT_A07_PROCEDURE  getPROCEDURE() { 
	   ...
	   try {
	      ret = (ADT_A07_PROCEDURE)this.get_Renamed("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public ADT_A07_PROCEDURE getPROCEDURE(int rep) { 
	   return (ADT_A07_PROCEDURE)this.get_Renamed("PROCEDURE", rep);
	}
