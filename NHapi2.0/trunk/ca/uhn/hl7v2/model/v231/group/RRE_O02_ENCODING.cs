...
/**
 * <p>Represents the RRE_O02_ENCODING Group.  A Group is an ordered collection of message 
...
public class RRE_O02_ENCODING : AbstractGroup {
	 ...
	 */
	public RRE_O02_ENCODING(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
