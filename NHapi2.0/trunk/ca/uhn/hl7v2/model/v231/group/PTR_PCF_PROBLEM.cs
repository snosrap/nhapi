...
public class PTR_PCF_PROBLEM : AbstractGroup {
	...
	public PTR_PCF_PROBLEM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PTR_PCF_PROBLEM_ROLE", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PTR_PCF_PROBLEM_OBSERVATION", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PTR_PCF_GOAL", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PTR_PCF_ORDER", "2.3.1"), false, true);
