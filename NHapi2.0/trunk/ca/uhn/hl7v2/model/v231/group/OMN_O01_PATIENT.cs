...
/**
 * <p>Represents the OMN_O01_PATIENT Group.  A Group is an ordered collection of message 
 ...
 * 3: OMN_O01_PATIENT_VISIT (a Group object) <b>optional </b><br>
 * 4: OMN_O01_INSURANCE (a Group object) <b>optional repeating</b><br>
...
public class OMN_O01_PATIENT : AbstractGroup {
	 ...
	 */
	public OMN_O01_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OMN_O01_PATIENT_VISIT", "2.3.1"), false, false);
	      this.add(factory.getGroupClass("OMN_O01_INSURANCE", "2.3.1"), false, true);
...
get{
	   ...
	   try {
	      ret = (OMN_O01_PATIENT_VISIT)this.get_Renamed("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public OMN_O01_INSURANCE  getINSURANCE() { 
	   ...
	   try {
	      ret = (OMN_O01_INSURANCE)this.get_Renamed("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public OMN_O01_INSURANCE getINSURANCE(int rep) { 
	   return (OMN_O01_INSURANCE)this.get_Renamed("INSURANCE", rep);
	}
