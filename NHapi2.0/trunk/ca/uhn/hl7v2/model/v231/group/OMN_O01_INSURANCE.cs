...
/**
 * <p>Represents the OMN_O01_INSURANCE Group.  A Group is an ordered collection of message 
...
public class OMN_O01_INSURANCE : AbstractGroup {
	 ...
	 */
	public OMN_O01_INSURANCE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("IN1", "2.3.1"), true, false);
	      this.add(factory.getSegmentClass("IN2", "2.3.1"), false, false);
	      this.add(factory.getSegmentClass("IN3", "2.3.1"), false, false);
