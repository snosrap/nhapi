...
/**
 * <p>Represents the ADT_A04_PROCEDURE Group.  A Group is an ordered collection of message 
...
public class ADT_A04_PROCEDURE : AbstractGroup {
	 ...
	 */
	public ADT_A04_PROCEDURE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
