...
public class CSU_C09_STUDY_SCHEDULE : AbstractGroup {
	...
	public CSU_C09_STUDY_SCHEDULE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("CSS", "2.3.1"), false, false);
	      this.add(factory.getGroupClass("CSU_C09_STUDY_OBSERVATION", "2.3.1"), true, true);
	      this.add(factory.getGroupClass("CSU_C09_STUDY_PHARM", "2.3.1"), true, true);
