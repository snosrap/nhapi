...
/**
 * <p>Represents the ADT_A31_PROCEDURE Group.  A Group is an ordered collection of message 
...
public class ADT_A31_PROCEDURE : AbstractGroup {
	 ...
	 */
	public ADT_A31_PROCEDURE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("PR1", "2.3.1"), true, false);
	      this.add(factory.getSegmentClass("ROL", "2.3.1"), false, true);
