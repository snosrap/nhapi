 ...
 * 5: PPR_PC1_PATHWAY_OBSERVATION (a Group object) <b>optional repeating</b><br>
...
public class PPR_PC1_PROBLEM : AbstractGroup {
	...
	public PPR_PC1_PROBLEM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPR_PC1_PROBLEM_ROLE", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PPR_PC1_PATHWAY", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PPR_PC1_PATHWAY_OBSERVATION", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PPR_PC1_GOAL", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PPR_PC1_ORDER", "2.3.1"), false, true);
...
{ 
	...
	public PPR_PC1_PATHWAY_OBSERVATION  getPATHWAY_OBSERVATION() { 
	   ...
	   try {
	      ret = (PPR_PC1_PATHWAY_OBSERVATION)this.get_Renamed("PATHWAY_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPR_PC1_PATHWAY_OBSERVATION getPATHWAY_OBSERVATION(int rep) { 
	   return (PPR_PC1_PATHWAY_OBSERVATION)this.get_Renamed("PATHWAY_OBSERVATION", rep);
	}

	/** 
	 * Returns the number of existing repetitions of PPR_PC1_PATHWAY_OBSERVATION 
	 */ 
	public int PATHWAY_OBSERVATIONReps 
{ 
get
{
	    int reps = -1; 
