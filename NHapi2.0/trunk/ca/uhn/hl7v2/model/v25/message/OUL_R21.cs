...
public class OUL_R21 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("OUL_R21_PATIENT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OUL_R21_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OUL_R21_ORDER_OBSERVATION", "2.5"), true, true);
