 ...
 * 10: VXR_V03_INSURANCE (a Group object) <b></b><br>
 * 11: VXR_V03_ORDER (a Group object) <b></b><br>
 */
...
public class VXR_V03 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("VXR_V03_PATIENT_VISIT", "2.5"), false, false);
	      this.add(factory.getSegmentClass("GT1", "2.5"), false, true);
	      this.add(factory.getGroupClass("VXR_V03_INSURANCE", "2.5"), true, false);
	      this.add(factory.getGroupClass("VXR_V03_ORDER", "2.5"), true, false);
