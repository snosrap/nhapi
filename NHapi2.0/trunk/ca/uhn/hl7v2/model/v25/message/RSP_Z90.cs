...
public class RSP_Z90 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("RCP", "2.5"), true, false);
	      this.add(factory.getGroupClass("RSP_Z90_QUERY_RESPONSE", "2.5"), true, true);
	      this.add(factory.getSegmentClass("DSC", "2.5"), true, false);
