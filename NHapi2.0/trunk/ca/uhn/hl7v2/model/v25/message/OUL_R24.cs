...
public class OUL_R24 : AbstractMessage  {
	...
	/** 
	 * Creates a new OUL_R24 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("OUL_R24_PATIENT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OUL_R24_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OUL_R24_ORDER", "2.5"), true, true);
