...
public class OUL_R22 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("OUL_R22_PATIENT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OUL_R22_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OUL_R22_SPECIMEN", "2.5"), true, true);
