 ...
 * 10: DFT_P11_COMMON_ORDER (a Group object) <b></b><br>
 ...
 * 14: DFT_P11_INSURANCE (a Group object) <b></b><br>
...
public class DFT_P11 : AbstractMessage  {
	...
	/** 
	 * Creates a new DFT_P11 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("PD1", "2.5"), false, false);
	      ...
	      this.add(factory.getGroupClass("DFT_P11_COMMON_ORDER", "2.5"), true, false);
	      ...
	      this.add(factory.getGroupClass("DFT_P11_INSURANCE", "2.5"), true, false);
	      this.add(factory.getSegmentClass("ACC", "2.5"), false, false);
	      this.add(factory.getGroupClass("DFT_P11_FINANCIAL", "2.5"), true, true);
