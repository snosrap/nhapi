...
public class MFR_M07 : AbstractMessage  {
	...
	/** 
	 * Creates a new MFR_M07 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("QAK", "2.5"), false, false);
	      ...
	      this.add(factory.getGroupClass("MFR_M07_MF_QUERY", "2.5"), true, true);
