 ...
 * 15: ADT_A05_PROCEDURE (a Group object) <b></b><br>
 * 16: GT1 (Guarantor) <b>optional repeating</b><br>
 * 17: ADT_A05_INSURANCE (a Group object) <b></b><br>
...
public class ADT_A05 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ADT_A05_PROCEDURE", "2.5"), true, false);
	      this.add(factory.getSegmentClass("GT1", "2.5"), false, true);
	      this.add(factory.getGroupClass("ADT_A05_INSURANCE", "2.5"), true, false);
