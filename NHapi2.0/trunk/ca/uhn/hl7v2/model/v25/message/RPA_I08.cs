...
public class RPA_I08 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RPA_I08_AUTHORIZATION_1", "2.5"), false, false);
	      this.add(factory.getGroupClass("RPA_I08_PROVIDER", "2.5"), true, true);
	      ...
	      this.add(factory.getGroupClass("RPA_I08_INSURANCE", "2.5"), false, true);
	      ...
	      this.add(factory.getGroupClass("RPA_I08_PROCEDURE", "2.5"), true, true);
	      this.add(factory.getGroupClass("RPA_I08_OBSERVATION", "2.5"), false, true);
	      this.add(factory.getGroupClass("RPA_I08_VISIT", "2.5"), false, false);
