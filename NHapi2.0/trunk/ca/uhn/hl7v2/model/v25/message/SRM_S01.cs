...
public class SRM_S01 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("ARQ", "2.5"), true, false);
	      this.add(factory.getSegmentClass("APR", "2.5"), false, false);
	      this.add(factory.getSegmentClass("NTE", "2.5"), false, true);
	      this.add(factory.getGroupClass("SRM_S01_PATIENT", "2.5"), true, false);
	      this.add(factory.getGroupClass("SRM_S01_RESOURCES", "2.5"), true, true);
