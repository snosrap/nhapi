...
public class ADT_A03 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ADT_A03_PROCEDURE", "2.5"), true, false);
	      this.add(factory.getSegmentClass("OBX", "2.5"), false, true);
	      this.add(factory.getSegmentClass("GT1", "2.5"), false, true);
	      this.add(factory.getGroupClass("ADT_A03_INSURANCE", "2.5"), true, false);
	      this.add(factory.getSegmentClass("ACC", "2.5"), false, false);
	      this.add(factory.getSegmentClass("PDA", "2.5"), false, false);
