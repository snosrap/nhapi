...
public class RQA_I08 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RQA_I08_AUTHORIZATION", "2.5"), false, false);
	      this.add(factory.getGroupClass("RQA_I08_PROVIDER", "2.5"), true, true);
	      this.add(factory.getSegmentClass("PID", "2.5"), true, false);
	      this.add(factory.getSegmentClass("NK1", "2.5"), false, true);
	      this.add(factory.getGroupClass("RQA_I08_GUARANTOR_INSURANCE", "2.5"), false, false);
	      ...
	      this.add(factory.getGroupClass("RQA_I08_PROCEDURE", "2.5"), false, true);
	      this.add(factory.getGroupClass("RQA_I08_OBSERVATION", "2.5"), false, true);
	      this.add(factory.getGroupClass("RQA_I08_VISIT", "2.5"), false, false);
