...
public class OMD_O03 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("OMD_O03_PATIENT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OMD_O03_ORDER_DIET", "2.5"), true, true);
	      this.add(factory.getGroupClass("OMD_O03_ORDER_TRAY", "2.5"), true, false);
