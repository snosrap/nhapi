 ...
 * 7: VXU_V04_INSURANCE (a Group object) <b></b><br>
 * 8: VXU_V04_ORDER (a Group object) <b></b><br>
 */
...
public class VXU_V04 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("VXU_V04_PATIENT", "2.5"), false, false);
	      this.add(factory.getSegmentClass("GT1", "2.5"), false, true);
	      this.add(factory.getGroupClass("VXU_V04_INSURANCE", "2.5"), true, false);
	      this.add(factory.getGroupClass("VXU_V04_ORDER", "2.5"), true, false);
