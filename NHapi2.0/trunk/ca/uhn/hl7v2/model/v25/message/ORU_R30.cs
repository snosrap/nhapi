...
public class ORU_R30 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ORU_R30_VISIT", "2.5"), false, false);
	      ...
	      this.add(factory.getGroupClass("ORU_R30_TIMING_QTY", "2.5"), true, false);
	      this.add(factory.getGroupClass("ORU_R30_OBSERVATION", "2.5"), true, true);
