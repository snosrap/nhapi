...
public class ADT_A06 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("MRG", "2.5"), false, false);
	      ...
	      this.add(factory.getGroupClass("ADT_A06_PROCEDURE", "2.5"), true, false);
	      this.add(factory.getSegmentClass("GT1", "2.5"), false, true);
	      this.add(factory.getGroupClass("ADT_A06_INSURANCE", "2.5"), true, false);
