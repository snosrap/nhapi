...
public class OUL_R23 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("OUL_R23_PATIENT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OUL_R23_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OUL_R23_SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI", "2.5"), true, true);
