 ...
 * 4: SIU_S12_PATIENT (a Group object) <b></b><br>
...
public class SIU_S12 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("SIU_S12_PATIENT", "2.5"), true, false);
	      this.add(factory.getGroupClass("SIU_S12_RESOURCES", "2.5"), true, true);
