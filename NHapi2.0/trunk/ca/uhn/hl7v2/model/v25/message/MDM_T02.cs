 ...
 * 5: MDM_T02_COMMON_ORDER (a Group object) <b></b><br>
...
public class MDM_T02 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("MDM_T02_COMMON_ORDER", "2.5"), true, false);
	      this.add(factory.getSegmentClass("TXA", "2.5"), true, false);
	      this.add(factory.getGroupClass("MDM_T02_OBXNTE", "2.5"), true, true);
