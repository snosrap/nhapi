...
public class PMU_B01 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("PRA", "2.5"), false, true);
	      this.add(factory.getSegmentClass("ORG", "2.5"), false, true);
	      this.add(factory.getSegmentClass("AFF", "2.5"), false, true);
	      this.add(factory.getSegmentClass("LAN", "2.5"), false, true);
	      this.add(factory.getSegmentClass("EDU", "2.5"), false, true);
	      this.add(factory.getSegmentClass("CER", "2.5"), false, true);
