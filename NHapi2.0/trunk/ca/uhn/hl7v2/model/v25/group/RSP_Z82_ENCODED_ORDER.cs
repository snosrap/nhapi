...
/**
 * <p>Represents the RSP_Z82_ENCODED_ORDER Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: RXE (Pharmacy/Treatment Encoded Order) <b></b><br>
 * 1: RSP_Z82_TIMING_ENCODED (a Group object) <b></b><br>
...
public class RSP_Z82_ENCODED_ORDER : AbstractGroup {
	...
	public RSP_Z82_ENCODED_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RSP_Z82_TIMING_ENCODED", "2.5"), true, false);
