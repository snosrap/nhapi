 ...
 * 1: RGV_O15_TIMING (a Group object) <b></b><br>
...
public class RGV_O15_ORDER : AbstractGroup {
	...
	public RGV_O15_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RGV_O15_TIMING", "2.5"), true, false);
	      this.add(factory.getGroupClass("RGV_O15_ORDER_DETAIL", "2.5"), false, false);
	      this.add(factory.getGroupClass("RGV_O15_ENCODING", "2.5"), false, false);
	      this.add(factory.getGroupClass("RGV_O15_GIVE", "2.5"), true, true);
