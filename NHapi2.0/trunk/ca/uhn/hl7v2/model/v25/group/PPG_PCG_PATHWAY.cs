 ...
 * 3: PPG_PCG_PATHWAY_ROLE (a Group object) <b></b><br>
 * 4: PPG_PCG_GOAL (a Group object) <b></b><br>
 */
...
public class PPG_PCG_PATHWAY : AbstractGroup {
	...
	public PPG_PCG_PATHWAY(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPG_PCG_PATHWAY_ROLE", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPG_PCG_GOAL", "2.5"), true, false);
