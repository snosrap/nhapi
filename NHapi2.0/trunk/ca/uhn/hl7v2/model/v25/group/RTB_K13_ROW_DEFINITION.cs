...
/**
 * <p>Represents the RTB_K13_ROW_DEFINITION Group.  A Group is an ordered collection of message 
...
public class RTB_K13_ROW_DEFINITION : AbstractGroup {
	...
	public RTB_K13_ROW_DEFINITION(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("RDF", "2.5"), true, false);
	      this.add(factory.getSegmentClass("RDT", "2.5"), false, true);
