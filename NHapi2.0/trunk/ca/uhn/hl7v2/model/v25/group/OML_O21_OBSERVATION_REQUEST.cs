...
public class OML_O21_OBSERVATION_REQUEST : AbstractGroup {
	...
	public OML_O21_OBSERVATION_REQUEST(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OML_O21_OBSERVATION", "2.5"), true, false);
	      this.add(factory.getGroupClass("OML_O21_SPECIMEN", "2.5"), true, false);
	      this.add(factory.getGroupClass("OML_O21_PRIOR_RESULT", "2.5"), true, false);
