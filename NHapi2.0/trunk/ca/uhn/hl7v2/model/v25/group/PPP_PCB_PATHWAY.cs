 ...
 * 3: PPP_PCB_PATHWAY_ROLE (a Group object) <b></b><br>
 * 4: PPP_PCB_PROBLEM (a Group object) <b></b><br>
 */
...
public class PPP_PCB_PATHWAY : AbstractGroup {
	...
	public PPP_PCB_PATHWAY(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPP_PCB_PATHWAY_ROLE", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPP_PCB_PROBLEM", "2.5"), true, false);
