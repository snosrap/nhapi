 ...
 * 1: RSP_Z90_TIMING (a Group object) <b></b><br>
...
public class RSP_Z90_COMMON_ORDER : AbstractGroup {
	...
	public RSP_Z90_COMMON_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RSP_Z90_TIMING", "2.5"), true, false);
	      ...
	      this.add(factory.getGroupClass("RSP_Z90_OBSERVATION", "2.5"), true, true);
