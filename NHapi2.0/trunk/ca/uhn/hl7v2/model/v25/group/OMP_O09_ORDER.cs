...
public class OMP_O09_ORDER : AbstractGroup {
	...
	public OMP_O09_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OMP_O09_TIMING", "2.5"), true, false);
	      ...
	      this.add(factory.getGroupClass("OMP_O09_COMPONENT", "2.5"), true, false);
	      this.add(factory.getGroupClass("OMP_O09_OBSERVATION", "2.5"), true, false);
