...
public class OML_O33_PRIOR_RESULT : AbstractGroup {
	...
	public OML_O33_PRIOR_RESULT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getGroupClass("OML_O33_PATIENT_PRIOR", "2.5"), false, false);
	      this.add(factory.getGroupClass("OML_O33_PATIENT_VISIT_PRIOR", "2.5"), false, false);
	      this.add(factory.getSegmentClass("AL1", "2.5"), false, true);
	      this.add(factory.getGroupClass("OML_O33_ORDER_PRIOR", "2.5"), true, true);
