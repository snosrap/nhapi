...
public class EAC_U07_COMMAND : AbstractGroup {
	...
	public EAC_U07_COMMAND(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("ECD", "2.5"), true, false);
	      this.add(factory.getSegmentClass("TQ1", "2.5"), false, false);
	      this.add(factory.getGroupClass("EAC_U07_SPECIMEN_CONTAINER", "2.5"), false, false);
	      this.add(factory.getSegmentClass("CNS", "2.5"), false, false);
