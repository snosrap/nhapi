...
/**
 * <p>Represents the RDS_O13_PATIENT Group.  A Group is an ordered collection of message 
...
public class RDS_O13_PATIENT : AbstractGroup {
	...
	public RDS_O13_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RDS_O13_PATIENT_VISIT", "2.5"), false, false);
