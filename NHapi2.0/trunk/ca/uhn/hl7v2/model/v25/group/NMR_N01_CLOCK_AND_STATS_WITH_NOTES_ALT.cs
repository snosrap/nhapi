...
public class NMR_N01_CLOCK_AND_STATS_WITH_NOTES_ALT : AbstractGroup {
	...
	public NMR_N01_CLOCK_AND_STATS_WITH_NOTES_ALT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("NCK", "2.5"), false, false);
	      this.add(factory.getSegmentClass("NTE", "2.5"), false, true);
	      this.add(factory.getSegmentClass("NST", "2.5"), false, false);
	      this.add(factory.getSegmentClass("NTE", "2.5"), false, true);
	      this.add(factory.getSegmentClass("NSC", "2.5"), false, false);
	      this.add(factory.getSegmentClass("NTE", "2.5"), false, true);
