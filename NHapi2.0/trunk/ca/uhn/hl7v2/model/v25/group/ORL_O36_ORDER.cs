 ...
 * 1: ORL_O36_TIMING (a Group object) <b></b><br>
...
public class ORL_O36_ORDER : AbstractGroup {
	...
	public ORL_O36_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("ORL_O36_TIMING", "2.5"), true, false);
	      this.add(factory.getGroupClass("ORL_O36_OBSERVATION_REQUEST", "2.5"), false, false);
