...
/**
 * <p>Represents the OMD_O03_PATIENT Group.  A Group is an ordered collection of message 
 ...
 * 4: OMD_O03_INSURANCE (a Group object) <b></b><br>
...
public class OMD_O03_PATIENT : AbstractGroup {
	...
	public OMD_O03_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OMD_O03_PATIENT_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OMD_O03_INSURANCE", "2.5"), true, false);
