...
/**
 * <p>Represents the PTR_PCF_GOAL Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: GOL (Goal Detail) <b></b><br>
 * 1: NTE (Notes and Comments) <b>optional repeating</b><br>
 * 2: VAR (Variance) <b>optional repeating</b><br>
 * 3: PTR_PCF_GOAL_ROLE (a Group object) <b></b><br>
 * 4: PTR_PCF_GOAL_OBSERVATION (a Group object) <b></b><br>
 */
...
public class PTR_PCF_GOAL : AbstractGroup {
	...
	public PTR_PCF_GOAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PTR_PCF_GOAL_ROLE", "2.5"), true, false);
	      this.add(factory.getGroupClass("PTR_PCF_GOAL_OBSERVATION", "2.5"), true, false);
