 ...
 * 1: DFT_P11_FINANCIAL_TIMING_QUANTITY (a Group object) <b></b><br>
 * 2: DFT_P11_FINANCIAL_ORDER (a Group object) <b>optional </b><br>
 * 3: DFT_P11_FINANCIAL_OBSERVATION (a Group object) <b></b><br>
 */
...
public class DFT_P11_FINANCIAL_COMMON_ORDER : AbstractGroup {
	...
	public DFT_P11_FINANCIAL_COMMON_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("DFT_P11_FINANCIAL_TIMING_QUANTITY", "2.5"), true, false);
	      this.add(factory.getGroupClass("DFT_P11_FINANCIAL_ORDER", "2.5"), false, false);
	      this.add(factory.getGroupClass("DFT_P11_FINANCIAL_OBSERVATION", "2.5"), true, false);
