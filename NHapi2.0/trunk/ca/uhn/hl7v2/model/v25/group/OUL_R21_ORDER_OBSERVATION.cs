 ...
 * 4: OUL_R21_TIMING_QTY (a Group object) <b></b><br>
...
public class OUL_R21_ORDER_OBSERVATION : AbstractGroup {
	...
	public OUL_R21_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getGroupClass("OUL_R21_CONTAINER", "2.5"), false, false);
	      ...
	      this.add(factory.getGroupClass("OUL_R21_TIMING_QTY", "2.5"), true, false);
	      this.add(factory.getGroupClass("OUL_R21_OBSERVATION", "2.5"), true, true);
