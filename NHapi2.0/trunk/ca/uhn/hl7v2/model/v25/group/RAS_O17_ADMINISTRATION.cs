...
public class RAS_O17_ADMINISTRATION : AbstractGroup {
	...
	public RAS_O17_ADMINISTRATION(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("RXA", "2.5"), true, true);
	      this.add(factory.getSegmentClass("RXR", "2.5"), true, false);
	      this.add(factory.getGroupClass("RAS_O17_OBSERVATION", "2.5"), true, false);
