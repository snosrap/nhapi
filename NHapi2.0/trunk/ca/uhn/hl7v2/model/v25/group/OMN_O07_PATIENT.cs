...
/**
 * <p>Represents the OMN_O07_PATIENT Group.  A Group is an ordered collection of message 
 ...
 * 4: OMN_O07_INSURANCE (a Group object) <b></b><br>
...
public class OMN_O07_PATIENT : AbstractGroup {
	...
	public OMN_O07_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OMN_O07_PATIENT_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OMN_O07_INSURANCE", "2.5"), true, false);
