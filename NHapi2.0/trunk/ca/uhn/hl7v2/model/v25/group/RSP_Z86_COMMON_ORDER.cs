 ...
 * 1: RSP_Z86_TIMING (a Group object) <b></b><br>
...
public class RSP_Z86_COMMON_ORDER : AbstractGroup {
	...
	public RSP_Z86_COMMON_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RSP_Z86_TIMING", "2.5"), true, false);
	      this.add(factory.getGroupClass("RSP_Z86_ORDER_DETAIL", "2.5"), false, false);
	      this.add(factory.getGroupClass("RSP_Z86_ENCODED_ORDER", "2.5"), false, false);
	      this.add(factory.getGroupClass("RSP_Z86_DISPENSE", "2.5"), false, false);
	      this.add(factory.getGroupClass("RSP_Z86_GIVE", "2.5"), false, false);
	      this.add(factory.getGroupClass("RSP_Z86_ADMINISTRATION", "2.5"), false, false);
	      this.add(factory.getGroupClass("RSP_Z86_OBSERVATION", "2.5"), true, true);
