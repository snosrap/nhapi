 ...
 * 1: OML_O21_TIIMING (a Group object) <b></b><br>
...
public class OML_O21_ORDER : AbstractGroup {
	...
	public OML_O21_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OML_O21_TIIMING", "2.5"), true, false);
	      this.add(factory.getGroupClass("OML_O21_OBSERVATION_REQUEST", "2.5"), false, false);
