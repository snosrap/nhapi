...
public class ORU_R01_ORDER_OBSERVATION : AbstractGroup {
	...
	public ORU_R01_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("ORU_R01_TIMING_QTY", "2.5"), true, false);
	      this.add(factory.getSegmentClass("CTD", "2.5"), false, false);
	      this.add(factory.getGroupClass("ORU_R01_OBSERVATION", "2.5"), true, false);
	      this.add(factory.getSegmentClass("FT1", "2.5"), false, true);
	      this.add(factory.getSegmentClass("CTI", "2.5"), false, true);
	      this.add(factory.getGroupClass("ORU_R01_SPECIMEN", "2.5"), true, false);
