...
/**
 * <p>Represents the OML_O35_ORDER_PRIOR Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: ORC (Common Order) <b>optional </b><br>
 * 1: OBR (Observation Request) <b></b><br>
 * 2: NTE (Notes and Comments) <b>optional repeating</b><br>
 * 3: OML_O35_TIMING_PRIOR (a Group object) <b></b><br>
...
public class OML_O35_ORDER_PRIOR : AbstractGroup {
	...
	public OML_O35_ORDER_PRIOR(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OML_O35_TIMING_PRIOR", "2.5"), true, false);
	      this.add(factory.getGroupClass("OML_O35_OBSERVATION_PRIOR", "2.5"), true, true);
