...
/**
 * <p>Represents the PPP_PCB_GOAL Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: GOL (Goal Detail) <b></b><br>
 * 1: NTE (Notes and Comments) <b>optional repeating</b><br>
 * 2: VAR (Variance) <b>optional repeating</b><br>
 * 3: PPP_PCB_GOAL_ROLE (a Group object) <b></b><br>
 * 4: PPP_PCB_GOAL_OBSERVATION (a Group object) <b></b><br>
 */
...
public class PPP_PCB_GOAL : AbstractGroup {
	...
	public PPP_PCB_GOAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPP_PCB_GOAL_ROLE", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPP_PCB_GOAL_OBSERVATION", "2.5"), true, false);
