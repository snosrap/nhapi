 ...
 * 1: OML_O33_TIIMING (a Group object) <b></b><br>
...
public class OML_O33_ORDER : AbstractGroup {
	...
	public OML_O33_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OML_O33_TIIMING", "2.5"), true, false);
	      this.add(factory.getGroupClass("OML_O33_OBSERVATION_REQUEST", "2.5"), false, false);
