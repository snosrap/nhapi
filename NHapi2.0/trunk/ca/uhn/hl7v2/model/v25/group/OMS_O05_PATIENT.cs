 ...
 * 4: OMS_O05_INSURANCE (a Group object) <b></b><br>
...
public class OMS_O05_PATIENT : AbstractGroup {
	...
	public OMS_O05_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OMS_O05_PATIENT_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OMS_O05_INSURANCE", "2.5"), true, false);
