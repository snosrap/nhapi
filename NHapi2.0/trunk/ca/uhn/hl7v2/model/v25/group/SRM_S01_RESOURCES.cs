...
public class SRM_S01_RESOURCES : AbstractGroup {
	...
	public SRM_S01_RESOURCES(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("SRM_S01_SERVICE", "2.5"), true, false);
	      this.add(factory.getGroupClass("SRM_S01_GENERAL_RESOURCE", "2.5"), true, false);
	      this.add(factory.getGroupClass("SRM_S01_LOCATION_RESOURCE", "2.5"), true, false);
	      this.add(factory.getGroupClass("SRM_S01_PERSONNEL_RESOURCE", "2.5"), true, false);
