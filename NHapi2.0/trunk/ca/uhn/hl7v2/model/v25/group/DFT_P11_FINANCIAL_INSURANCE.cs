...
/**
 * <p>Represents the DFT_P11_FINANCIAL_INSURANCE Group.  A Group is an ordered collection of message 
...
public class DFT_P11_FINANCIAL_INSURANCE : AbstractGroup {
	...
	public DFT_P11_FINANCIAL_INSURANCE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("IN1", "2.5"), true, false);
	      this.add(factory.getSegmentClass("IN2", "2.5"), false, false);
	      this.add(factory.getSegmentClass("IN3", "2.5"), false, true);
