...
public class OMI_O23_ORDER : AbstractGroup {
	...
	public OMI_O23_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OMI_O23_TIMING", "2.5"), true, false);
	      ...
	      this.add(factory.getGroupClass("OMI_O23_OBSERVATION", "2.5"), true, false);
