 ...
 * 3: ORF_R04_TIMING_QTY (a Group object) <b></b><br>
...
public class ORF_R04_ORDER : AbstractGroup {
	...
	public ORF_R04_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("ORF_R04_TIMING_QTY", "2.5"), true, false);
	      this.add(factory.getSegmentClass("CTD", "2.5"), false, false);
	      this.add(factory.getGroupClass("ORF_R04_OBSERVATION", "2.5"), true, true);
