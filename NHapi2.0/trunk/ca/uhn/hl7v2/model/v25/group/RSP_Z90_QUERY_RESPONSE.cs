 ...
 * 2: RSP_Z90_SPECIMEN (a Group object) <b></b><br>
 */
...
public class RSP_Z90_QUERY_RESPONSE : AbstractGroup {
	...
	public RSP_Z90_QUERY_RESPONSE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getGroupClass("RSP_Z90_PATIENT", "2.5"), false, false);
	      this.add(factory.getGroupClass("RSP_Z90_COMMON_ORDER", "2.5"), true, true);
	      this.add(factory.getGroupClass("RSP_Z90_SPECIMEN", "2.5"), true, false);
