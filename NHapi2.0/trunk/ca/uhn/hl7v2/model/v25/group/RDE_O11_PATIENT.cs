 ...
 * 4: RDE_O11_INSURANCE (a Group object) <b></b><br>
...
public class RDE_O11_PATIENT : AbstractGroup {
	...
	public RDE_O11_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RDE_O11_PATIENT_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("RDE_O11_INSURANCE", "2.5"), true, false);
