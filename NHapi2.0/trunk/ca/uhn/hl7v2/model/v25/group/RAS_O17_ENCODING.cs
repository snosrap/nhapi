...
/**
 * <p>Represents the RAS_O17_ENCODING Group.  A Group is an ordered collection of message 
...
public class RAS_O17_ENCODING : AbstractGroup {
	...
	public RAS_O17_ENCODING(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RAS_O17_TIMING_ENCODED", "2.5"), true, true);
