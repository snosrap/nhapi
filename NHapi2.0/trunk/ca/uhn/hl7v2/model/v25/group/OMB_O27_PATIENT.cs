...
/**
 * <p>Represents the OMB_O27_PATIENT Group.  A Group is an ordered collection of message 
 ...
 * 4: OMB_O27_INSURANCE (a Group object) <b></b><br>
...
public class OMB_O27_PATIENT : AbstractGroup {
	...
	public OMB_O27_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OMB_O27_PATIENT_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OMB_O27_INSURANCE", "2.5"), true, false);
