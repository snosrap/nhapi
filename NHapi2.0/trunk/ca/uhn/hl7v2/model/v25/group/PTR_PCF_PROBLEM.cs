 ...
 * 3: PTR_PCF_PROBLEM_ROLE (a Group object) <b></b><br>
 * 4: PTR_PCF_PROBLEM_OBSERVATION (a Group object) <b></b><br>
 * 5: PTR_PCF_GOAL (a Group object) <b></b><br>
 * 6: PTR_PCF_ORDER (a Group object) <b></b><br>
 */
...
public class PTR_PCF_PROBLEM : AbstractGroup {
	...
	public PTR_PCF_PROBLEM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PTR_PCF_PROBLEM_ROLE", "2.5"), true, false);
	      this.add(factory.getGroupClass("PTR_PCF_PROBLEM_OBSERVATION", "2.5"), true, false);
	      this.add(factory.getGroupClass("PTR_PCF_GOAL", "2.5"), true, false);
	      this.add(factory.getGroupClass("PTR_PCF_ORDER", "2.5"), true, false);
