...
public class ORG_O20_ORDER : AbstractGroup {
	...
	public ORG_O20_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("ORG_O20_TIMING", "2.5"), true, false);
	      this.add(factory.getSegmentClass("OBR", "2.5"), false, false);
	      this.add(factory.getSegmentClass("NTE", "2.5"), false, true);
	      this.add(factory.getSegmentClass("CTI", "2.5"), false, true);
	      this.add(factory.getGroupClass("ORG_O20_SPECIMEN", "2.5"), true, false);
