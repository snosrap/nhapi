...
/**
 * <p>Represents the OML_O35_PATIENT Group.  A Group is an ordered collection of message 
 ...
 * 5: OML_O35_INSURANCE (a Group object) <b></b><br>
...
public class OML_O35_PATIENT : AbstractGroup {
	...
	public OML_O35_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OML_O35_PATIENT_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OML_O35_INSURANCE", "2.5"), true, false);
