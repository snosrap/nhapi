...
/**
 * <p>Represents the OMP_O09_PATIENT Group.  A Group is an ordered collection of message 
 ...
 * 4: OMP_O09_INSURANCE (a Group object) <b></b><br>
...
public class OMP_O09_PATIENT : AbstractGroup {
	...
	public OMP_O09_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OMP_O09_PATIENT_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OMP_O09_INSURANCE", "2.5"), true, false);
