 ...
 * 5: OML_O33_INSURANCE (a Group object) <b></b><br>
...
public class OML_O33_PATIENT : AbstractGroup {
	...
	public OML_O33_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OML_O33_PATIENT_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OML_O33_INSURANCE", "2.5"), true, false);
