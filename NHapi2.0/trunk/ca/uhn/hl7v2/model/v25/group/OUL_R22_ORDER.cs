 ...
 * 3: OUL_R22_TIMING_QTY (a Group object) <b></b><br>
 * 4: OUL_R22_RESULT (a Group object) <b></b><br>
...
public class OUL_R22_ORDER : AbstractGroup {
	...
	public OUL_R22_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OUL_R22_TIMING_QTY", "2.5"), true, false);
	      this.add(factory.getGroupClass("OUL_R22_RESULT", "2.5"), true, false);
