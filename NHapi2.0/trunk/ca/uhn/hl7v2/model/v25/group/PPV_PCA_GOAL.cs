...
public class PPV_PCA_GOAL : AbstractGroup {
	...
	public PPV_PCA_GOAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPV_PCA_GOAL_ROLE", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPV_PCA_GOAL_PATHWAY", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPV_PCA_GOAL_OBSERVATION", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPV_PCA_PROBLEM", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPV_PCA_ORDER", "2.5"), true, false);
