 ...
 * 3: PPG_PCG_PROBLEM_ROLE (a Group object) <b></b><br>
 * 4: PPG_PCG_PROBLEM_OBSERVATION (a Group object) <b></b><br>
 */
...
public class PPG_PCG_PROBLEM : AbstractGroup {
	...
	public PPG_PCG_PROBLEM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPG_PCG_PROBLEM_ROLE", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPG_PCG_PROBLEM_OBSERVATION", "2.5"), true, false);
