...
public class BAR_P01_VISIT : AbstractGroup {
	...
	public BAR_P01_VISIT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("BAR_P01_PROCEDURE", "2.5"), true, false);
	      this.add(factory.getSegmentClass("GT1", "2.5"), false, true);
	      this.add(factory.getSegmentClass("NK1", "2.5"), false, true);
	      this.add(factory.getGroupClass("BAR_P01_INSURANCE", "2.5"), true, false);
