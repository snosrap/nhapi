 ...
 * 2: ORD_O04_ORDER_TRAY (a Group object) <b></b><br>
 */
...
public class ORD_O04_RESPONSE : AbstractGroup {
	...
	public ORD_O04_RESPONSE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getGroupClass("ORD_O04_PATIENT", "2.5"), false, false);
	      this.add(factory.getGroupClass("ORD_O04_ORDER_DIET", "2.5"), true, true);
	      this.add(factory.getGroupClass("ORD_O04_ORDER_TRAY", "2.5"), true, false);
