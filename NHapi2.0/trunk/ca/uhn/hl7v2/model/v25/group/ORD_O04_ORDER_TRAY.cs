 ...
 * 1: ORD_O04_TIMING_TRAY (a Group object) <b></b><br>
...
public class ORD_O04_ORDER_TRAY : AbstractGroup {
	...
	public ORD_O04_ORDER_TRAY(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("ORD_O04_TIMING_TRAY", "2.5"), true, false);
	      this.add(factory.getSegmentClass("ODT", "2.5"), false, true);
