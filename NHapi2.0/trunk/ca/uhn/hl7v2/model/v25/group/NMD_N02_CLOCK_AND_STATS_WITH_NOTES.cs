...
public class NMD_N02_CLOCK_AND_STATS_WITH_NOTES : AbstractGroup {
	...
	public NMD_N02_CLOCK_AND_STATS_WITH_NOTES(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getGroupClass("NMD_N02_CLOCK", "2.5"), false, false);
	      this.add(factory.getGroupClass("NMD_N02_APP_STATS", "2.5"), false, false);
	      this.add(factory.getGroupClass("NMD_N02_APP_STATUS", "2.5"), false, false);
