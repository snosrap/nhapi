 ...
 * 1: RSP_Z88_TIMING (a Group object) <b></b><br>
...
public class RSP_Z88_COMMON_ORDER : AbstractGroup {
	...
	public RSP_Z88_COMMON_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RSP_Z88_TIMING", "2.5"), true, false);
	      this.add(factory.getGroupClass("RSP_Z88_ORDER_DETAIL", "2.5"), false, false);
	      this.add(factory.getGroupClass("RSP_Z88_ORDER_ENCODED", "2.5"), false, false);
	      ...
	      this.add(factory.getGroupClass("RSP_Z88_OBSERVATION", "2.5"), true, true);
