...
public class RAS_O17_ORDER : AbstractGroup {
	...
	public RAS_O17_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RAS_O17_TIMING", "2.5"), true, false);
	      this.add(factory.getGroupClass("RAS_O17_ORDER_DETAIL", "2.5"), false, false);
	      this.add(factory.getGroupClass("RAS_O17_ENCODING", "2.5"), false, false);
	      this.add(factory.getGroupClass("RAS_O17_ADMINISTRATION", "2.5"), true, true);
