...
public class DFT_P11_FINANCIAL : AbstractGroup {
	...
	public DFT_P11_FINANCIAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("DFT_P11_FINANCIAL_PROCEDURE", "2.5"), true, false);
	      this.add(factory.getGroupClass("DFT_P11_FINANCIAL_COMMON_ORDER", "2.5"), true, false);
	      ...
	      this.add(factory.getGroupClass("DFT_P11_FINANCIAL_INSURANCE", "2.5"), true, false);
