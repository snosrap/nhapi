...
public class MFN_M08_MF_TEST_NUMERIC : AbstractGroup {
	...
	public MFN_M08_MF_TEST_NUMERIC(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getSegmentClass("OM2", "2.5"), false, false);
	      this.add(factory.getSegmentClass("OM3", "2.5"), false, false);
	      this.add(factory.getSegmentClass("OM4", "2.5"), false, false);
