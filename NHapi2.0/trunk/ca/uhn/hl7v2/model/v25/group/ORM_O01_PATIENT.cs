...
/**
 * <p>Represents the ORM_O01_PATIENT Group.  A Group is an ordered collection of message 
 ...
 * 4: ORM_O01_INSURANCE (a Group object) <b></b><br>
...
public class ORM_O01_PATIENT : AbstractGroup {
	...
	public ORM_O01_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("ORM_O01_PATIENT_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("ORM_O01_INSURANCE", "2.5"), true, false);
