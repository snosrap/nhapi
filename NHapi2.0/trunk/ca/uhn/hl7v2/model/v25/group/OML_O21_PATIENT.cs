...
/**
 * <p>Represents the OML_O21_PATIENT Group.  A Group is an ordered collection of message 
 ...
 * 5: OML_O21_INSURANCE (a Group object) <b></b><br>
...
public class OML_O21_PATIENT : AbstractGroup {
	...
	public OML_O21_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OML_O21_PATIENT_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OML_O21_INSURANCE", "2.5"), true, false);
