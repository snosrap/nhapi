...
public class RSP_Z82_COMMON_ORDER : AbstractGroup {
	...
	public RSP_Z82_COMMON_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RSP_Z82_TIMING", "2.5"), true, false);
	      this.add(factory.getGroupClass("RSP_Z82_ORDER_DETAIL", "2.5"), false, false);
	      this.add(factory.getGroupClass("RSP_Z82_ENCODED_ORDER", "2.5"), false, false);
	      ...
	      this.add(factory.getGroupClass("RSP_Z82_OBSERVATION", "2.5"), true, true);
