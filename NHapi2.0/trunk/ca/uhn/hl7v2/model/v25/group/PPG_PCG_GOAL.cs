...
public class PPG_PCG_GOAL : AbstractGroup {
	...
	public PPG_PCG_GOAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPG_PCG_GOAL_ROLE", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPG_PCG_GOAL_OBSERVATION", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPG_PCG_PROBLEM", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPG_PCG_ORDER", "2.5"), true, false);
