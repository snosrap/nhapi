...
public class PGL_PC6_GOAL : AbstractGroup {
	...
	public PGL_PC6_GOAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PGL_PC6_GOAL_ROLE", "2.5"), true, false);
	      this.add(factory.getGroupClass("PGL_PC6_PATHWAY", "2.5"), true, false);
	      this.add(factory.getGroupClass("PGL_PC6_OBSERVATION", "2.5"), true, false);
	      this.add(factory.getGroupClass("PGL_PC6_PROBLEM", "2.5"), true, false);
	      this.add(factory.getGroupClass("PGL_PC6_ORDER", "2.5"), true, false);
