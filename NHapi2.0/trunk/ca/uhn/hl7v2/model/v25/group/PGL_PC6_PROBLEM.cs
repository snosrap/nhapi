 ...
 * 3: PGL_PC6_PROBLEM_ROLE (a Group object) <b></b><br>
 * 4: PGL_PC6_PROBLEM_OBSERVATION (a Group object) <b></b><br>
 */
...
public class PGL_PC6_PROBLEM : AbstractGroup {
	...
	public PGL_PC6_PROBLEM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PGL_PC6_PROBLEM_ROLE", "2.5"), true, false);
	      this.add(factory.getGroupClass("PGL_PC6_PROBLEM_OBSERVATION", "2.5"), true, false);
