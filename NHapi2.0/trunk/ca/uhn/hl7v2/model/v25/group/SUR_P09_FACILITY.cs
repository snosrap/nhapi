...
public class SUR_P09_FACILITY : AbstractGroup {
	...
	public SUR_P09_FACILITY(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("FAC", "2.5"), true, false);
	      this.add(factory.getGroupClass("SUR_P09_PRODUCT", "2.5"), true, true);
	      this.add(factory.getSegmentClass("PSH", "2.5"), true, false);
	      this.add(factory.getGroupClass("SUR_P09_FACILITY_DETAIL", "2.5"), true, true);
	      this.add(factory.getSegmentClass("ED", "2.5"), true, false);
