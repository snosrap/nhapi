 ...
 * 3: PRR_PC5_GOAL_ROLE (a Group object) <b></b><br>
 * 4: PRR_PC5_GOAL_OBSERVATION (a Group object) <b></b><br>
 */
...
public class PRR_PC5_GOAL : AbstractGroup {
	...
	public PRR_PC5_GOAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PRR_PC5_GOAL_ROLE", "2.5"), true, false);
	      this.add(factory.getGroupClass("PRR_PC5_GOAL_OBSERVATION", "2.5"), true, false);
