 ...
 * 2: CSU_C09_TIMING_QTY (a Group object) <b></b><br>
...
public class CSU_C09_STUDY_OBSERVATION : AbstractGroup {
	...
	public CSU_C09_STUDY_OBSERVATION(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("CSU_C09_TIMING_QTY", "2.5"), true, false);
	      this.add(factory.getSegmentClass("OBX", "2.5"), true, true);
