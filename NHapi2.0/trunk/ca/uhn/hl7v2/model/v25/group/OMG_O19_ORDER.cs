...
public class OMG_O19_ORDER : AbstractGroup {
	...
	public OMG_O19_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OMG_O19_TIMING", "2.5"), true, false);
	      ...
	      this.add(factory.getGroupClass("OMG_O19_OBSERVATION", "2.5"), true, false);
	      this.add(factory.getGroupClass("OMG_O19_SPECIMEN", "2.5"), true, false);
	      this.add(factory.getGroupClass("OMG_O19_PRIOR_RESULT", "2.5"), true, false);
