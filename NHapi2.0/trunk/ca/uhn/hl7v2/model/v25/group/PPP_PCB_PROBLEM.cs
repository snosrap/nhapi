 ...
 * 3: PPP_PCB_PROBLEM_ROLE (a Group object) <b></b><br>
 * 4: PPP_PCB_PROBLEM_OBSERVATION (a Group object) <b></b><br>
 * 5: PPP_PCB_GOAL (a Group object) <b></b><br>
 * 6: PPP_PCB_ORDER (a Group object) <b></b><br>
 */
...
public class PPP_PCB_PROBLEM : AbstractGroup {
	...
	public PPP_PCB_PROBLEM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPP_PCB_PROBLEM_ROLE", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPP_PCB_PROBLEM_OBSERVATION", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPP_PCB_GOAL", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPP_PCB_ORDER", "2.5"), true, false);
