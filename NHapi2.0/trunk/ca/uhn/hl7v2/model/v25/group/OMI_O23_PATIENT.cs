...
/**
 * <p>Represents the OMI_O23_PATIENT Group.  A Group is an ordered collection of message 
 ...
 * 4: OMI_O23_INSURANCE (a Group object) <b></b><br>
...
public class OMI_O23_PATIENT : AbstractGroup {
	...
	public OMI_O23_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OMI_O23_PATIENT_VISIT", "2.5"), false, false);
	      this.add(factory.getGroupClass("OMI_O23_INSURANCE", "2.5"), true, false);
	      this.add(factory.getSegmentClass("GT1", "2.5"), false, false);
