...
/**
 * <p>Represents the RGV_O15_PATIENT Group.  A Group is an ordered collection of message 
...
public class RGV_O15_PATIENT : AbstractGroup {
	...
	public RGV_O15_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RGV_O15_PATIENT_VISIT", "2.5"), false, false);
