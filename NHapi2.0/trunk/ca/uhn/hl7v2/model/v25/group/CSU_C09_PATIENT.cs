...
public class CSU_C09_PATIENT : AbstractGroup {
	...
	public CSU_C09_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("CSU_C09_VISIT", "2.5"), false, false);
	      this.add(factory.getSegmentClass("CSR", "2.5"), true, false);
	      this.add(factory.getGroupClass("CSU_C09_STUDY_PHASE", "2.5"), true, true);
