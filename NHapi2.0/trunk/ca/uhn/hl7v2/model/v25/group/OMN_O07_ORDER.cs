 ...
 * 1: OMN_O07_TIMING (a Group object) <b></b><br>
 ...
 * 5: OMN_O07_OBSERVATION (a Group object) <b></b><br>
...
public class OMN_O07_ORDER : AbstractGroup {
	...
	public OMN_O07_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("OMN_O07_TIMING", "2.5"), true, false);
	      this.add(factory.getSegmentClass("RQD", "2.5"), true, false);
	      this.add(factory.getSegmentClass("RQ1", "2.5"), false, false);
	      this.add(factory.getSegmentClass("NTE", "2.5"), false, true);
	      this.add(factory.getGroupClass("OMN_O07_OBSERVATION", "2.5"), true, false);
