...
/**
 * <p>Represents the BPS_O29_PATIENT Group.  A Group is an ordered collection of message 
...
public class BPS_O29_PATIENT : AbstractGroup {
	...
	public BPS_O29_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("BPS_O29_PATIENT_VISIT", "2.5"), false, false);
