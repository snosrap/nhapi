...
/**
 * <p>Represents the PPV_PCA_PROBLEM Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: PRB (Problem Details) <b></b><br>
 * 1: NTE (Notes and Comments) <b>optional repeating</b><br>
 * 2: VAR (Variance) <b>optional repeating</b><br>
 * 3: PPV_PCA_PROBLEM_ROLE (a Group object) <b></b><br>
 * 4: PPV_PCA_PROBLEM_OBSERVATION (a Group object) <b></b><br>
 */
...
public class PPV_PCA_PROBLEM : AbstractGroup {
	...
	public PPV_PCA_PROBLEM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPV_PCA_PROBLEM_ROLE", "2.5"), true, false);
	      this.add(factory.getGroupClass("PPV_PCA_PROBLEM_OBSERVATION", "2.5"), true, false);
