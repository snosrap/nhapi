...
namespace ca.uhn.hl7v2
{
	...
	public class NormativeDatabase
	{
		...
		public static NormativeDatabase Instance
		{
			get
			{
				lock (typeof(ca.uhn.hl7v2.NormativeDatabase))
				{
					if (db == null)
					{
		...
		//UPGRADE_NOTE: The initialization of  'log' was moved to static method 'ca.uhn.hl7v2.NormativeDatabase'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
