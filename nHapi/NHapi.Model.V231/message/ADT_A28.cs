...
/**
 * <p>Represents a ADT_A28 message structure (see chapter [AAA]). This structure contains the 
 ...
 * 12: ADT_A28_PROCEDURE (a Group object) <b>optional repeating</b><br>
 * 13: GT1 (GT1 - guarantor segment) <b>optional repeating</b><br>
 * 14: ADT_A28_INSURANCE (a Group object) <b>optional repeating</b><br>
...
public class ADT_A28 : AbstractMessage  {
	...
	/** 
	 * Creates a new ADT_A28 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ADT_A28_PROCEDURE", "2.3.1"), false, true);
	      this.add(factory.getSegmentClass("GT1", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("ADT_A28_INSURANCE", "2.3.1"), false, true);
...
get{
	...
	public ADT_A28_PROCEDURE  getPROCEDURE() { 
	   ...
	   try {
	      ret = (ADT_A28_PROCEDURE)this.get_Renamed("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public ADT_A28_PROCEDURE getPROCEDURE(int rep) { 
	   return (ADT_A28_PROCEDURE)this.get_Renamed("PROCEDURE", rep);
	}
