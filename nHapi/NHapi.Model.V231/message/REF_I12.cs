...
public class REF_I12 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("RF1", "2.3.1"), false, false);
	      this.add(factory.getGroupClass("REF_I12_AUTHORIZATION_CONTACT", "2.3.1"), false, false);
	      this.add(factory.getGroupClass("REF_I12_PROVIDER", "2.3.1"), true, true);
	      ...
	      this.add(factory.getGroupClass("REF_I12_INSURANCE", "2.3.1"), false, true);
	      this.add(factory.getSegmentClass("ACC", "2.3.1"), false, false);
	      this.add(factory.getSegmentClass("DG1", "2.3.1"), false, true);
	      this.add(factory.getSegmentClass("DRG", "2.3.1"), false, true);
	      this.add(factory.getSegmentClass("AL1", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("REF_I12_PROCEDURE", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("REF_I12_OBSERVATION", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("REF_I12_PATIENT_VISIT", "2.3.1"), false, false);
