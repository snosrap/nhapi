...
/**
 * <p>Represents a RDS_O01 message structure (see chapter [AAA]). This structure contains the 
 * following elements: </p>
 * 0: MSH (MSH - message header segment) <b></b><br>
 * 1: NTE (NTE - notes and comments segment) <b>optional repeating</b><br>
 * 2: RDS_O01_PATIENT (a Group object) <b>optional </b><br>
 * 3: RDS_O01_ORDER (a Group object) <b>repeating</b><br>
 */
...
public class RDS_O01 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RDS_O01_PATIENT", "2.3.1"), false, false);
	      this.add(factory.getGroupClass("RDS_O01_ORDER", "2.3.1"), true, true);
...
get{
	   ...
	   try {
	      ret = (RDS_O01_PATIENT)this.get_Renamed("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RDS_O01_ORDER  getORDER() { 
	   ...
	   try {
	      ret = (RDS_O01_ORDER)this.get_Renamed("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RDS_O01_ORDER getORDER(int rep) { 
	   return (RDS_O01_ORDER)this.get_Renamed("ORDER", rep);
	}
