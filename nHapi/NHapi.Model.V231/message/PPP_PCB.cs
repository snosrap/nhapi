...
/**
 * <p>Represents a PPP_PCB message structure (see chapter ). This structure contains the 
...
public class PPP_PCB : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("PPP_PCB_PATIENT_VISIT", "2.3.1"), false, false);
	      this.add(factory.getGroupClass("PPP_PCB_PATHWAY", "2.3.1"), true, true);
