...
/**
 * <p>Represents a RRE_O02 message structure (see chapter [AAA]). This structure contains the 
 ...
 * 4: RRE_O02_RESPONSE (a Group object) <b>optional </b><br>
 */
...
public class RRE_O02 : AbstractMessage  {
	...
	/** 
	 * Creates a new RRE_O02 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RRE_O02_RESPONSE", "2.3.1"), false, false);
...
get{
	   ...
	   try {
	      ret = (RRE_O02_RESPONSE)this.get_Renamed("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
