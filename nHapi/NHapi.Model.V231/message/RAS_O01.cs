...
/**
 * <p>Represents a RAS_O01 message structure (see chapter [AAA]). This structure contains the 
...
public class RAS_O01 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RAS_O01_PATIENT", "2.3.1"), false, false);
	      this.add(factory.getGroupClass("RAS_O01_ORDER", "2.3.1"), true, true);
...
get{
	   ...
	   try {
	      ret = (RAS_O01_PATIENT)this.get_Renamed("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RAS_O01_ORDER  getORDER() { 
	   ...
	   try {
	      ret = (RAS_O01_ORDER)this.get_Renamed("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RAS_O01_ORDER getORDER(int rep) { 
	   return (RAS_O01_ORDER)this.get_Renamed("ORDER", rep);
	}
