...
/**
 * <p>Represents a PEX_P07 message structure (see chapter ). This structure contains the 
...
public class PEX_P07 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("PEX_P07_VISIT", "2.3.1"), false, false);
	      this.add(factory.getGroupClass("PEX_P07_EXPERIENCE", "2.3.1"), true, true);
