...
/**
 * <p>Represents a ADR_A19 message structure (see chapter [AAA]). This structure contains the 
...
public class ADR_A19 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ADR_A19_QUERY_RESPONSE", "2.3.1"), true, true);
