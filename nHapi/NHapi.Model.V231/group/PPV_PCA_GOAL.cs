...
public class PPV_PCA_GOAL : AbstractGroup {
	...
	public PPV_PCA_GOAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("GOL", "2.3.1"), true, false);
	      this.add(factory.getSegmentClass("NTE", "2.3.1"), false, true);
	      this.add(factory.getSegmentClass("VAR", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PPV_PCA_GOAL_ROLE", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PPV_PCA_GOAL_PATHWAY", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PPV_PCA_GOAL_OBSERVATION", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PPV_PCA_PROBLEM", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PPV_PCA_ORDER", "2.3.1"), false, true);
