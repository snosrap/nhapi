...
public class SRR_S01_RESOURCES : AbstractGroup {
	...
	public SRR_S01_RESOURCES(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("SRR_S01_SERVICE", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("SRR_S01_GENERAL_RESOURCE", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("SRR_S01_LOCATION_RESOURCE", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("SRR_S01_PERSONNEL_RESOURCE", "2.3.1"), false, true);
