...
public class MFN_M05_MF_LOCATION : AbstractGroup {
	...
	public MFN_M05_MF_LOCATION(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getSegmentClass("LOC", "2.3.1"), true, false);
	      this.add(factory.getSegmentClass("LCH", "2.3.1"), false, true);
	      this.add(factory.getSegmentClass("LRL", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("MFN_M05_MF_LOC_DEPT", "2.3.1"), true, true);
