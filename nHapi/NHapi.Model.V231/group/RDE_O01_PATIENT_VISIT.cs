...
/**
 * <p>Represents the RDE_O01_PATIENT_VISIT Group.  A Group is an ordered collection of message 
...
public class RDE_O01_PATIENT_VISIT : AbstractGroup {
	 ...
	 */
	public RDE_O01_PATIENT_VISIT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
