 ...
 * 5: RDE_O01_OBSERVATION (a Group object) <b>optional repeating</b><br>
...
public class RDE_O01_ORDER : AbstractGroup {
	...
	public RDE_O01_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RDE_O01_ORDER_DETAIL", "2.3.1"), false, false);
	      this.add(factory.getSegmentClass("RXE", "2.3.1"), true, false);
	      this.add(factory.getSegmentClass("RXR", "2.3.1"), true, true);
	      this.add(factory.getSegmentClass("RXC", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("RDE_O01_OBSERVATION", "2.3.1"), false, true);
