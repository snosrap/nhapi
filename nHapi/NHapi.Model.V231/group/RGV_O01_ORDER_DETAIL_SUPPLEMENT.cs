...
/**
 * <p>Represents the RGV_O01_ORDER_DETAIL_SUPPLEMENT Group.  A Group is an ordered collection of message 
 ...
 * 2: RGV_O01_COMPONENTS (a Group object) <b>optional </b><br>
 */
...
public class RGV_O01_ORDER_DETAIL_SUPPLEMENT : AbstractGroup {
	 ...
	 */
	public RGV_O01_ORDER_DETAIL_SUPPLEMENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("NTE", "2.3.1"), true, true);
	      this.add(factory.getSegmentClass("RXR", "2.3.1"), true, true);
	      this.add(factory.getGroupClass("RGV_O01_COMPONENTS", "2.3.1"), false, false);
...
get{
	   ...
	   try {
	      ret = (RGV_O01_COMPONENTS)this.get_Renamed("COMPONENTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
