...
/**
 * <p>Represents the ADT_A41_PATIENT Group.  A Group is an ordered collection of message 
...
public class ADT_A41_PATIENT : AbstractGroup {
	 ...
	 */
	public ADT_A41_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
