...
/**
 * <p>Represents the RPI_I04_GUARANTOR_INSURANCE Group.  A Group is an ordered collection of message 
...
public class RPI_I04_GUARANTOR_INSURANCE : AbstractGroup {
	...
	public RPI_I04_GUARANTOR_INSURANCE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RPI_I04_INSURANCE", "2.3.1"), true, true);
