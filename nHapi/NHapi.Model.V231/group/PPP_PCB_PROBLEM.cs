...
public class PPP_PCB_PROBLEM : AbstractGroup {
	...
	public PPP_PCB_PROBLEM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPP_PCB_PROBLEM_ROLE", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PPP_PCB_PROBLEM_OBSERVATION", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PPP_PCB_GOAL", "2.3.1"), false, true);
	      this.add(factory.getGroupClass("PPP_PCB_ORDER", "2.3.1"), false, true);
