...
namespace NHapi.Base.sourcegen
{
	...
	public class SegmentGenerator:System.Object
	{
		...
		//UPGRADE_NOTE: The initialization of  'log' was moved to static method 'NHapi.Base.sourcegen.SegmentGenerator'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		...
		public static System.String makeSegment(System.String name, System.String version)
		{
			...
			try
			{
				...
				if (elements.Count > 0)
				{
                    ...
                    source.Append("        HapiLogFactory.getHapiLog(GetType()).error(\"Can't instantiate \" + this.GetType().FullName, he);\r\n");
					source.Append("    }\r\n");
				}
				source.Append("  }\r\n\r\n");
