...
/**
 * <p>Represents a MFN_M09 message structure (see chapter 8). This structure contains the 
...
public class MFN_M09 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("MFN_M09_MF_TEST_CATEGORICAL", "2.4"), true, true);
