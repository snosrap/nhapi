...
/**
 * <p>Represents a RSP_Z88 message structure (see chapter 5). This structure contains the 
...
public class RSP_Z88 : AbstractMessage  {
	...
	/** 
	 * Creates a new RSP_Z88 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RSP_Z88_QUERY_RESPONSE", "2.4"), false, true);
	      this.add(factory.getSegmentClass("DSC", "2.4"), true, false);
