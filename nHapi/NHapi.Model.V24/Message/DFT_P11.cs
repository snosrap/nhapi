...
/**
 * <p>Represents a DFT_P11 message structure (see chapter 6.4.3). This structure contains the 
...
public class DFT_P11 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("DFT_P11_COMMON_ORDER", "2.4"), false, true);
	      ...
	      this.add(factory.getGroupClass("DFT_P11_INSURANCE", "2.4"), false, true);
	      this.add(factory.getSegmentClass("ACC", "2.4"), false, false);
	      this.add(factory.getGroupClass("DFT_P11_FINANCIAL", "2.4"), true, true);
