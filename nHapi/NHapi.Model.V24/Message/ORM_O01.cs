...
/**
 * <p>Represents a ORM_O01 message structure (see chapter 4). This structure contains the 
...
public class ORM_O01 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ORM_O01_PATIENT", "2.4"), false, false);
	      this.add(factory.getGroupClass("ORM_O01_ORDER", "2.4"), true, true);
