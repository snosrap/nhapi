...
/**
 * <p>Represents a RPI_I04 message structure (see chapter 11). This structure contains the 
...
public class RPI_I04 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RPI_I04_PROVIDER", "2.4"), true, true);
	      this.add(factory.getSegmentClass("PID", "2.4"), true, false);
	      this.add(factory.getSegmentClass("NK1", "2.4"), false, true);
	      this.add(factory.getGroupClass("RPI_I04_GUARANTOR_INSURANCE", "2.4"), false, false);
