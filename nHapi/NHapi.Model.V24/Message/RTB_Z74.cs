...
/**
 * <p>Represents a RTB_Z74 message structure (see chapter 4). This structure contains the 
...
public class RTB_Z74 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RTB_Z74_ROW_DEFINITION", "2.4"), false, false);
