...
/**
 * <p>Represents a RRA_O18 message structure (see chapter 4). This structure contains the 
...
public class RRA_O18 : AbstractMessage  {
	...
	/** 
	 * Creates a new RRA_O18 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RRA_O18_RESPONSE", "2.4"), false, false);
