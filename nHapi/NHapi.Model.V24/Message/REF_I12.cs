...
/**
 * <p>Represents a REF_I12 message structure (see chapter 11). This structure contains the 
...
public class REF_I12 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("REF_I12_PROVIDER_CONTACT", "2.4"), true, true);
	      ...
	      this.add(factory.getGroupClass("REF_I12_INSURANCE", "2.4"), false, true);
	      ...
	      this.add(factory.getGroupClass("REF_I12_PROCEDURE", "2.4"), false, true);
	      this.add(factory.getGroupClass("REF_I12_OBSERVATION", "2.4"), false, true);
	      this.add(factory.getGroupClass("REF_I12_PATIENT_VISIT", "2.4"), false, false);
