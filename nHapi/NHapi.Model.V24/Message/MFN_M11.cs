...
/**
 * <p>Represents a MFN_M11 message structure (see chapter 8). This structure contains the 
...
public class MFN_M11 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("MFN_M11_MF_TEST_CALCULATED", "2.4"), true, true);
