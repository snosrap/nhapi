...
/**
 * <p>Represents a RPA_I08 message structure (see chapter 11). This structure contains the 
...
public class RPA_I08 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RPA_I08_PROVIDER", "2.4"), true, true);
	      ...
	      this.add(factory.getGroupClass("RPA_I08_INSURANCE", "2.4"), false, true);
	      ...
	      this.add(factory.getGroupClass("RPA_I08_PROCEDURE", "2.4"), true, true);
	      this.add(factory.getGroupClass("RPA_I08_OBSERVATION", "2.4"), false, true);
	      this.add(factory.getGroupClass("RPA_I08_VISIT", "2.4"), false, false);
