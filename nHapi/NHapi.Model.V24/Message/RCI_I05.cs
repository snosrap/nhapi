...
/**
 * <p>Represents a RCI_I05 message structure (see chapter 11). This structure contains the 
...
public class RCI_I05 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RCI_I05_PROVIDER", "2.4"), true, true);
	      ...
	      this.add(factory.getGroupClass("RCI_I05_OBSERVATION", "2.4"), false, true);
