...
/**
 * <p>Represents a RSP_K24 message structure (see chapter 3). This structure contains the 
...
public class RSP_K24 : AbstractMessage  {
	...
	/** 
	 * Creates a new RSP_K24 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("PID", "2.4"), false, false);
