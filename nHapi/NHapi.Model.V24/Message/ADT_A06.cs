...
/**
 * <p>Represents a ADT_A06 message structure (see chapter 3). This structure contains the 
...
public class ADT_A06 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("MRG", "2.4"), false, false);
	      ...
	      this.add(factory.getGroupClass("ADT_A06_PROCEDURE", "2.4"), false, true);
	      this.add(factory.getSegmentClass("GT1", "2.4"), false, true);
	      this.add(factory.getGroupClass("ADT_A06_INSURANCE", "2.4"), false, true);
