...
/**
 * <p>Represents a ORL_O22 message structure (see chapter 4). This structure contains the 
...
public class ORL_O22 : AbstractMessage  {
	...
	/** 
	 * Creates a new ORL_O22 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("ORL_O22_RESPONSE", "2.4"), false, false);
