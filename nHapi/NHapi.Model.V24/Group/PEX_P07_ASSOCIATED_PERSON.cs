...
public class PEX_P07_ASSOCIATED_PERSON : AbstractGroup {
	...
	public PEX_P07_ASSOCIATED_PERSON(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("NK1", "2.4"), true, false);
	      this.add(factory.getGroupClass("PEX_P07_ASSOCIATED_RX_ORDER", "2.4"), false, false);
	      this.add(factory.getGroupClass("PEX_P07_ASSOCIATED_RX_ADMIN", "2.4"), false, true);
