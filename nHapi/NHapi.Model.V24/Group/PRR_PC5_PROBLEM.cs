...
public class PRR_PC5_PROBLEM : AbstractGroup {
	...
	public PRR_PC5_PROBLEM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PRR_PC5_PROBLEM_ROLE", "2.4"), false, true);
	      this.add(factory.getGroupClass("PRR_PC5_PROBLEM_PATHWAY", "2.4"), false, true);
	      this.add(factory.getGroupClass("PRR_PC5_PROBLEM_OBSERVATION", "2.4"), false, true);
	      this.add(factory.getGroupClass("PRR_PC5_GOAL", "2.4"), false, true);
	      this.add(factory.getGroupClass("PRR_PC5_ORDER", "2.4"), false, true);
