...
public class NMQ_N01_CLOCK_AND_STATISTICS : AbstractGroup {
	...
	public NMQ_N01_CLOCK_AND_STATISTICS(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("NCK", "2.4"), false, false);
	      this.add(factory.getSegmentClass("NST", "2.4"), false, false);
	      this.add(factory.getSegmentClass("NSC", "2.4"), false, false);
