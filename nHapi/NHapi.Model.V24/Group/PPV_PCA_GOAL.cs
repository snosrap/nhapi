...
public class PPV_PCA_GOAL : AbstractGroup {
	...
	public PPV_PCA_GOAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPV_PCA_GOAL_ROLE", "2.4"), false, true);
	      this.add(factory.getGroupClass("PPV_PCA_GOAL_PATHWAY", "2.4"), false, true);
	      this.add(factory.getGroupClass("PPV_PCA_GOAL_OBSERVATION", "2.4"), false, true);
	      this.add(factory.getGroupClass("PPV_PCA_PROBLEM", "2.4"), false, true);
	      this.add(factory.getGroupClass("PPV_PCA_ORDER", "2.4"), false, true);
