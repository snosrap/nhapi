...
public class PGL_PC6_GOAL : AbstractGroup {
	...
	public PGL_PC6_GOAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PGL_PC6_GOAL_ROLE", "2.4"), false, true);
	      this.add(factory.getGroupClass("PGL_PC6_PATHWAY", "2.4"), false, true);
	      this.add(factory.getGroupClass("PGL_PC6_OBSERVATION", "2.4"), false, true);
	      this.add(factory.getGroupClass("PGL_PC6_PROBLEM", "2.4"), false, true);
	      this.add(factory.getGroupClass("PGL_PC6_ORDER", "2.4"), false, true);
