...
public class RSP_Z86_COMMON_ORDER : AbstractGroup {
	...
	public RSP_Z86_COMMON_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RSP_Z86_ORDER_DETAIL", "2.4"), false, false);
	      this.add(factory.getGroupClass("RSP_Z86_ENCODED_ORDER", "2.4"), false, false);
	      this.add(factory.getGroupClass("RSP_Z86_DISPENSE", "2.4"), false, false);
	      this.add(factory.getGroupClass("RSP_Z86_GIVE", "2.4"), false, false);
	      this.add(factory.getGroupClass("RSP_Z86_ADMINISTRATION", "2.4"), false, false);
	      this.add(factory.getGroupClass("RSP_Z86_OBSERVATION", "2.4"), true, true);
