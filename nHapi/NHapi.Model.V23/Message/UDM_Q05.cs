 ...
 * 1: URD (Results/update definition segment) <b></b><br>
 * 2: URS (Unsolicited selection segment) <b>optional </b><br>
 * 3: DSP (Display data segment) <b>repeating</b><br>
...
public class UDM_Q05 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("URD", "2.3"), true, false);
	      this.add(factory.getSegmentClass("URS", "2.3"), false, false);
