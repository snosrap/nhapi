...
/**
 * <p>Represents a CRM_C08 message structure (see chapter [AAA]). This structure contains the 
 * following elements: </p>
 * 0: MSH (Message header segment) <b></b><br>
 * 1: CRM_C08_PATIENT (a Group object) <b>repeating</b><br>
 */
...
public class CRM_C08 : AbstractMessage  {
	...
	/** 
	 * Creates a new CRM_C08 Group with custom ModelClassFactory.
	 */
	public CRM_C08(ModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("CRM_C08_PATIENT", "2.3"), true, true);
...
get{
	...
	public CRM_C08_PATIENT  getPATIENT() { 
	   ...
	   try {
	      ret = (CRM_C08_PATIENT)this.get_Renamed("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public CRM_C08_PATIENT getPATIENT(int rep) { 
	   return (CRM_C08_PATIENT)this.get_Renamed("PATIENT", rep);
	}
