...
/**
 * <p>Represents a TBR_Q01 message structure (see chapter [AAA]). This structure contains the 
...
public class TBR_Q01 : AbstractMessage  {
	...
	/** 
	 * Creates a new TBR_Q01 Group with custom ModelClassFactory.
	 */
	public TBR_Q01(ModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getSegmentClass("RDF", "2.3"), true, false);
	      this.add(factory.getSegmentClass("RDT", "2.3"), true, true);
