...
/**
 * <p>Represents a PEX_P08 message structure (see chapter [AAA]). This structure contains the 
 ...
 * 5: PEX_P08_VISIT (a Group object) <b>optional </b><br>
 * 6: PEX_P08_EXPERIENCE (a Group object) <b>repeating</b><br>
 */
...
public class PEX_P08 : AbstractMessage  {
	...
	/** 
	 * Creates a new PEX_P08 Group with custom ModelClassFactory.
	 */
	public PEX_P08(ModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("PEX_P08_VISIT", "2.3"), false, false);
	      this.add(factory.getGroupClass("PEX_P08_EXPERIENCE", "2.3"), true, true);
...
get{
	   ...
	   try {
	      ret = (PEX_P08_VISIT)this.get_Renamed("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PEX_P08_EXPERIENCE  getEXPERIENCE() { 
	   ...
	   try {
	      ret = (PEX_P08_EXPERIENCE)this.get_Renamed("EXPERIENCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PEX_P08_EXPERIENCE getEXPERIENCE(int rep) { 
	   return (PEX_P08_EXPERIENCE)this.get_Renamed("EXPERIENCE", rep);
	}
