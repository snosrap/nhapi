...
public class RRI_I12 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RRI_I12_AUTHORIZATION", "2.3"), false, false);
	      this.add(factory.getGroupClass("RRI_I12_PROVIDER", "2.3"), true, true);
	      ...
	      this.add(factory.getGroupClass("RRI_I12_PROCEDURE", "2.3"), false, true);
	      this.add(factory.getGroupClass("RRI_I12_RESULTS", "2.3"), false, true);
	      this.add(factory.getGroupClass("RRI_I12_VISIT", "2.3"), false, false);
