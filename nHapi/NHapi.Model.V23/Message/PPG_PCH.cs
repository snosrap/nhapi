...
/**
 * <p>Represents a PPG_PCH message structure (see chapter [AAA]). This structure contains the 
...
public class PPG_PCH : AbstractMessage  {
	 ...
	 */
	public PPG_PCH(ModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("PPG_PCH_PATIENT_VISIT", "2.3"), false, false);
	      this.add(factory.getGroupClass("PPG_PCH_PATHWAY", "2.3"), true, true);
...
get{
	   ...
	   try {
	      ret = (PPG_PCH_PATIENT_VISIT)this.get_Renamed("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPG_PCH_PATHWAY  getPATHWAY() { 
	   ...
	   try {
	      ret = (PPG_PCH_PATHWAY)this.get_Renamed("PATHWAY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPG_PCH_PATHWAY getPATHWAY(int rep) { 
	   return (PPG_PCH_PATHWAY)this.get_Renamed("PATHWAY", rep);
	}
