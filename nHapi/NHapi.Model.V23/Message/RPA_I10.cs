...
/**
 * <p>Represents a RPA_I10 message structure (see chapter [AAA]). This structure contains the 
...
public class RPA_I10 : AbstractMessage  {
	 ...
	 */
	public RPA_I10(ModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RPA_I10_AUTHORIZATION", "2.3"), false, false);
	      this.add(factory.getGroupClass("RPA_I10_PROVIDER", "2.3"), true, true);
	      ...
	      this.add(factory.getGroupClass("RPA_I10_INSURANCE", "2.3"), false, true);
	      ...
	      this.add(factory.getGroupClass("RPA_I10_PROCEDURE", "2.3"), true, true);
	      this.add(factory.getGroupClass("RPA_I10_RESULTS", "2.3"), false, true);
	      this.add(factory.getGroupClass("RPA_I10_VISIT", "2.3"), false, false);
...
get{
	   ...
	   try {
	      ret = (RPA_I10_AUTHORIZATION)this.get_Renamed("AUTHORIZATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RPA_I10_PROVIDER  getPROVIDER() { 
	   ...
	   try {
	      ret = (RPA_I10_PROVIDER)this.get_Renamed("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RPA_I10_PROVIDER getPROVIDER(int rep) { 
	   return (RPA_I10_PROVIDER)this.get_Renamed("PROVIDER", rep);
	}
...
{ 
	...
	public RPA_I10_INSURANCE  getINSURANCE() { 
	   ...
	   try {
	      ret = (RPA_I10_INSURANCE)this.get_Renamed("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RPA_I10_INSURANCE getINSURANCE(int rep) { 
	   return (RPA_I10_INSURANCE)this.get_Renamed("INSURANCE", rep);
	}
...
{ 
	...
	public RPA_I10_PROCEDURE  getPROCEDURE() { 
	   ...
	   try {
	      ret = (RPA_I10_PROCEDURE)this.get_Renamed("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RPA_I10_PROCEDURE getPROCEDURE(int rep) { 
	   return (RPA_I10_PROCEDURE)this.get_Renamed("PROCEDURE", rep);
	}
...
{ 
	...
	public RPA_I10_RESULTS  getRESULTS() { 
	   ...
	   try {
	      ret = (RPA_I10_RESULTS)this.get_Renamed("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public RPA_I10_RESULTS getRESULTS(int rep) { 
	   return (RPA_I10_RESULTS)this.get_Renamed("RESULTS", rep);
	}
...
get{
	   ...
	   try {
	      ret = (RPA_I10_VISIT)this.get_Renamed("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
