...
/**
 * <p>Represents a SRM_S06 message structure (see chapter [AAA]). This structure contains the 
 ...
 * 4: SRM_S06_PATIENT (a Group object) <b>optional repeating</b><br>
 * 5: SRM_S06_RESOURCES (a Group object) <b>repeating</b><br>
 */
...
public class SRM_S06 : AbstractMessage  {
	...
	/** 
	 * Creates a new SRM_S06 Group with custom ModelClassFactory.
	 */
	public SRM_S06(ModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("SRM_S06_PATIENT", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRM_S06_RESOURCES", "2.3"), true, true);
...
{ 
	...
	public SRM_S06_PATIENT  getPATIENT() { 
	   ...
	   try {
	      ret = (SRM_S06_PATIENT)this.get_Renamed("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRM_S06_PATIENT getPATIENT(int rep) { 
	   return (SRM_S06_PATIENT)this.get_Renamed("PATIENT", rep);
	}
...
{ 
	...
	public SRM_S06_RESOURCES  getRESOURCES() { 
	   ...
	   try {
	      ret = (SRM_S06_RESOURCES)this.get_Renamed("RESOURCES");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SRM_S06_RESOURCES getRESOURCES(int rep) { 
	   return (SRM_S06_RESOURCES)this.get_Renamed("RESOURCES", rep);
	}
