...
/**
 * <p>Represents a REF_I12 message structure (see chapter [AAA]). This structure contains the 
 * following elements: </p>
 * 0: MSH (Message header segment) <b></b><br>
 * 1: RF1 (Referral Information Segment) <b>optional </b><br>
 * 2: REF_I12_AUTHORIZATION (a Group object) <b>optional </b><br>
 * 3: REF_I12_PROVIDER (a Group object) <b>repeating</b><br>
 ...
 * 13: REF_I12_RESULTS (a Group object) <b>optional repeating</b><br>
 * 14: REF_I12_VISIT (a Group object) <b>optional </b><br>
...
public class REF_I12 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("REF_I12_AUTHORIZATION", "2.3"), false, false);
	      this.add(factory.getGroupClass("REF_I12_PROVIDER", "2.3"), true, true);
	      ...
	      this.add(factory.getGroupClass("REF_I12_INSURANCE", "2.3"), false, true);
	      ...
	      this.add(factory.getGroupClass("REF_I12_PROCEDURE", "2.3"), false, true);
	      this.add(factory.getGroupClass("REF_I12_RESULTS", "2.3"), false, true);
	      this.add(factory.getGroupClass("REF_I12_VISIT", "2.3"), false, false);
...
get{
	   ...
	   try {
	      ret = (REF_I12_AUTHORIZATION)this.get_Renamed("AUTHORIZATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public REF_I12_PROVIDER  getPROVIDER() { 
	   ...
	   try {
	      ret = (REF_I12_PROVIDER)this.get_Renamed("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public REF_I12_PROVIDER getPROVIDER(int rep) { 
	   return (REF_I12_PROVIDER)this.get_Renamed("PROVIDER", rep);
	}
...
{ 
	...
	public REF_I12_RESULTS  getRESULTS() { 
	   ...
	   try {
	      ret = (REF_I12_RESULTS)this.get_Renamed("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public REF_I12_RESULTS getRESULTS(int rep) { 
	   return (REF_I12_RESULTS)this.get_Renamed("RESULTS", rep);
	}
...
get{
	   ...
	   try {
	      ret = (REF_I12_VISIT)this.get_Renamed("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
