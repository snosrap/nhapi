...
public class VXU_V04 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("VXU_V04_PATIENT", "2.3"), false, false);
	      this.add(factory.getGroupClass("VXU_V04_INSURANCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("VXU_V04_ORDER", "2.3"), false, true);
