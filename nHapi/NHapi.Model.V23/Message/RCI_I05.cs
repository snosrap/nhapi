...
/**
 * <p>Represents a RCI_I05 message structure (see chapter [AAA]). This structure contains the 
 ...
 * 10: NTE (Notes and comments segment) <b>optional repeating</b><br>
 */
...
public class RCI_I05 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("RCI_I05_PROVIDER", "2.3"), true, true);
	      ...
	      this.add(factory.getGroupClass("RCI_I05_OBSERVATION", "2.3"), false, true);
