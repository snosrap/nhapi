...
/**
 * <p>Represents a PPR_PC2 message structure (see chapter [AAA]). This structure contains the 
 * following elements: </p>
 * 0: MSH (Message header segment) <b></b><br>
 * 1: PID (Patient Identification) <b></b><br>
 * 2: PPR_PC2_PATIENT_VISIT (a Group object) <b>optional </b><br>
 * 3: PPR_PC2_PROBLEM (a Group object) <b>repeating</b><br>
 */
...
public class PPR_PC2 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("PPR_PC2_PATIENT_VISIT", "2.3"), false, false);
	      this.add(factory.getGroupClass("PPR_PC2_PROBLEM", "2.3"), true, true);
...
get{
	   ...
	   try {
	      ret = (PPR_PC2_PATIENT_VISIT)this.get_Renamed("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPR_PC2_PROBLEM  getPROBLEM() { 
	   ...
	   try {
	      ret = (PPR_PC2_PROBLEM)this.get_Renamed("PROBLEM");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PPR_PC2_PROBLEM getPROBLEM(int rep) { 
	   return (PPR_PC2_PROBLEM)this.get_Renamed("PROBLEM", rep);
	}
