...
public class OMD_O01 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("OMD_O01_PATIENT", "2.3"), false, false);
	      this.add(factory.getGroupClass("OMD_O01_ORDER_DIET", "2.3"), true, true);
	      this.add(factory.getGroupClass("OMD_O01_ORDER_TRAY", "2.3"), false, true);
