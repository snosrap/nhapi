...
/**
 * <p>Represents a SRM_S01 message structure (see chapter [AAA]). This structure contains the 
...
public class SRM_S01 : AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("SRM_S01_PATIENT", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRM_S01_RESOURCES", "2.3"), true, true);
