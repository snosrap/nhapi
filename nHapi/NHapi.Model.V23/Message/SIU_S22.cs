...
/**
 * <p>Represents a SIU_S22 message structure (see chapter [AAA]). This structure contains the 
 * following elements: </p>
 * 0: MSH (Message header segment) <b></b><br>
 * 1: SCH (Schedule Activity Information) <b></b><br>
 * 2: NTE (Notes and comments segment) <b>optional repeating</b><br>
 * 3: SIU_S22_PATIENT (a Group object) <b>optional repeating</b><br>
 * 4: SIU_S22_RESOURCES (a Group object) <b>repeating</b><br>
 */
...
public class SIU_S22 : AbstractMessage  {
	...
	/** 
	 * Creates a new SIU_S22 Group with custom ModelClassFactory.
	 */
	public SIU_S22(ModelClassFactory factory) : base(factory){
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(factory.getGroupClass("SIU_S22_PATIENT", "2.3"), false, true);
	      this.add(factory.getGroupClass("SIU_S22_RESOURCES", "2.3"), true, true);
...
{ 
	...
	public SIU_S22_PATIENT  getPATIENT() { 
	   ...
	   try {
	      ret = (SIU_S22_PATIENT)this.get_Renamed("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SIU_S22_PATIENT getPATIENT(int rep) { 
	   return (SIU_S22_PATIENT)this.get_Renamed("PATIENT", rep);
	}
...
{ 
	...
	public SIU_S22_RESOURCES  getRESOURCES() { 
	   ...
	   try {
	      ret = (SIU_S22_RESOURCES)this.get_Renamed("RESOURCES");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SIU_S22_RESOURCES getRESOURCES(int rep) { 
	   return (SIU_S22_RESOURCES)this.get_Renamed("RESOURCES", rep);
	}
