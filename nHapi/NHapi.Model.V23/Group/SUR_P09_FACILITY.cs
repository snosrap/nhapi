...
public class SUR_P09_FACILITY : AbstractGroup {
	...
	public SUR_P09_FACILITY(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("FAC", "2.3"), true, false);
	      this.add(factory.getGroupClass("SUR_P09_PRODUCT", "2.3"), true, true);
	      this.add(factory.getSegmentClass("PSH", "2.3"), true, false);
	      this.add(factory.getGroupClass("SUR_P09_FACILITY_DETAIL", "2.3"), true, true);
