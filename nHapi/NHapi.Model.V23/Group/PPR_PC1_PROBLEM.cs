...
public class PPR_PC1_PROBLEM : AbstractGroup {
	...
	public PPR_PC1_PROBLEM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPR_PC1_PROBLEM_ROLE", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPR_PC1_PATHWAY", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPR_PC1_PROBLEM_OBSERVATION", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPR_PC1_GOAL", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPR_PC1_ORDER", "2.3"), false, true);
