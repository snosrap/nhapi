...
/**
 * <p>Represents the ORF_R02_ORDER Group.  A Group is an ordered collection of message 
 ...
 * 3: ORF_R02_OBSERVATION (a Group object) <b>repeating</b><br>
...
public class ORF_R02_ORDER : AbstractGroup {
	 ...
	 */
	public ORF_R02_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("ORF_R02_OBSERVATION", "2.3"), true, true);
...
{ 
	...
	public ORF_R02_OBSERVATION  getOBSERVATION() { 
	   ...
	   try {
	      ret = (ORF_R02_OBSERVATION)this.get_Renamed("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public ORF_R02_OBSERVATION getOBSERVATION(int rep) { 
	   return (ORF_R02_OBSERVATION)this.get_Renamed("OBSERVATION", rep);
	}
