...
public class SQM_S25_RESOURCES : AbstractGroup {
	...
	public SQM_S25_RESOURCES(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("SQM_S25_SERVICE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SQM_S25_GENERAL_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SQM_S25_PERSONNEL_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SQM_S25_LOCATION_RESOURCE", "2.3"), false, true);
