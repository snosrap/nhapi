...
/**
 * <p>Represents the RRI_I13_PROVIDER Group.  A Group is an ordered collection of message 
...
public class RRI_I13_PROVIDER : AbstractGroup {
	 ...
	 */
	public RRI_I13_PROVIDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("PRD", "2.3"), true, false);
	      this.add(factory.getSegmentClass("CTD", "2.3"), false, true);
