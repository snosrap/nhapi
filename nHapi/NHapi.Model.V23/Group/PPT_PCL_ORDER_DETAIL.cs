...
/**
 * <p>Represents the PPT_PCL_ORDER_DETAIL Group.  A Group is an ordered collection of message 
 ...
 * 3: PPT_PCL_ORDER_OBSERVATION (a Group object) <b>optional repeating</b><br>
 */
...
public class PPT_PCL_ORDER_DETAIL : AbstractGroup {
	...
	public PPT_PCL_ORDER_DETAIL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPT_PCL_ORDER_OBSERVATION", "2.3"), false, true);
