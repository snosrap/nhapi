...
public class PPT_PCL_GOAL : AbstractGroup {
	...
	public PPT_PCL_GOAL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PPT_PCL_GOAL_ROLE", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPT_PCL_GOAL_OBSERVATION", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPT_PCL_PROBLEM", "2.3"), false, true);
	      this.add(factory.getGroupClass("PPT_PCL_ORDER", "2.3"), false, true);
