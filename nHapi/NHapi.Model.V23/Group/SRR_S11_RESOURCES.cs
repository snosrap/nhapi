...
public class SRR_S11_RESOURCES : AbstractGroup {
	...
	public SRR_S11_RESOURCES(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("SRR_S11_SERVICE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRR_S11_GENERAL_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRR_S11_LOCATION_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SRR_S11_PERSONNEL_RESOURCE", "2.3"), false, true);
