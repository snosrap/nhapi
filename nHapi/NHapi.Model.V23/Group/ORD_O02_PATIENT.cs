...
/**
 * <p>Represents the ORD_O02_PATIENT Group.  A Group is an ordered collection of message 
...
public class ORD_O02_PATIENT : AbstractGroup {
	 ...
	 */
	public ORD_O02_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
