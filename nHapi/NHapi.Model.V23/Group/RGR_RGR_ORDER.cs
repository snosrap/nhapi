 ...
 * 2: RXG (Pharmacy give segment) <b>repeating</b><br>
...
public class RGR_RGR_ORDER : AbstractGroup {
	...
	public RGR_RGR_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RGR_RGR_ENCODING", "2.3"), false, false);
	      this.add(factory.getSegmentClass("RXG", "2.3"), true, true);
