...
public class PGL_PC8_PROBLEM : AbstractGroup {
	 ...
	 */
	public PGL_PC8_PROBLEM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PGL_PC8_PROBLEM_ROLE", "2.3"), false, true);
	      this.add(factory.getGroupClass("PGL_PC8_PROBLEM_OBSERVATION", "2.3"), false, true);
...
{ 
	...
	public PGL_PC8_PROBLEM_ROLE  getPROBLEM_ROLE() { 
	   ...
	   try {
	      ret = (PGL_PC8_PROBLEM_ROLE)this.get_Renamed("PROBLEM_ROLE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PGL_PC8_PROBLEM_ROLE getPROBLEM_ROLE(int rep) { 
	   return (PGL_PC8_PROBLEM_ROLE)this.get_Renamed("PROBLEM_ROLE", rep);
	}
...
{ 
	...
	public PGL_PC8_PROBLEM_OBSERVATION  getPROBLEM_OBSERVATION() { 
	   ...
	   try {
	      ret = (PGL_PC8_PROBLEM_OBSERVATION)this.get_Renamed("PROBLEM_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PGL_PC8_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) { 
	   return (PGL_PC8_PROBLEM_OBSERVATION)this.get_Renamed("PROBLEM_OBSERVATION", rep);
	}
