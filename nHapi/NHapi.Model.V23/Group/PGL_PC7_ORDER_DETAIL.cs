...
/**
 * <p>Represents the PGL_PC7_ORDER_DETAIL Group.  A Group is an ordered collection of message 
 ...
 * 3: PGL_PC7_ORDER_OBSERVATION (a Group object) <b>optional repeating</b><br>
 */
...
public class PGL_PC7_ORDER_DETAIL : AbstractGroup {
	 ...
	 */
	public PGL_PC7_ORDER_DETAIL(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("PGL_PC7_ORDER_OBSERVATION", "2.3"), false, true);
...
{ 
	...
	public PGL_PC7_ORDER_OBSERVATION  getORDER_OBSERVATION() { 
	   ...
	   try {
	      ret = (PGL_PC7_ORDER_OBSERVATION)this.get_Renamed("ORDER_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public PGL_PC7_ORDER_OBSERVATION getORDER_OBSERVATION(int rep) { 
	   return (PGL_PC7_ORDER_OBSERVATION)this.get_Renamed("ORDER_OBSERVATION", rep);
	}
