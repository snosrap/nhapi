...
public class CSU_C12_STUDY_PHARM : AbstractGroup {
	 ...
	 */
	public CSU_C12_STUDY_PHARM(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("ORC", "2.3"), false, false);
	      this.add(factory.getGroupClass("CSU_C12_RX_ADMIN", "2.3"), true, true);
...
get{
	...
	public CSU_C12_RX_ADMIN  getRX_ADMIN() { 
	   ...
	   try {
	      ret = (CSU_C12_RX_ADMIN)this.get_Renamed("RX_ADMIN");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public CSU_C12_RX_ADMIN getRX_ADMIN(int rep) { 
	   return (CSU_C12_RX_ADMIN)this.get_Renamed("RX_ADMIN", rep);
	}
