...
public class RGV_O01_ORDER : AbstractGroup {
	...
	public RGV_O01_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RGV_O01_ORDER_DETAIL", "2.3"), false, false);
	      this.add(factory.getGroupClass("RGV_O01_ENCODING", "2.3"), false, false);
	      this.add(factory.getGroupClass("RGV_O01_GIVE", "2.3"), true, true);
