...
/**
 * <p>Represents the SIU_S26_RESOURCES Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: RGS (Resource Group) <b></b><br>
 * 1: SIU_S26_SERVICE (a Group object) <b>optional repeating</b><br>
 * 2: SIU_S26_GENERAL_RESOURCE (a Group object) <b>optional repeating</b><br>
 * 3: SIU_S26_LOCATION_RESOURCE (a Group object) <b>optional repeating</b><br>
 * 4: SIU_S26_PERSONNEL_RESOURCE (a Group object) <b>optional repeating</b><br>
 */
...
public class SIU_S26_RESOURCES : AbstractGroup {
	 ...
	 */
	public SIU_S26_RESOURCES(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("RGS", "2.3"), true, false);
	      this.add(factory.getGroupClass("SIU_S26_SERVICE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SIU_S26_GENERAL_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SIU_S26_LOCATION_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SIU_S26_PERSONNEL_RESOURCE", "2.3"), false, true);
...
get{
	...
	public SIU_S26_SERVICE  getSERVICE() { 
	   ...
	   try {
	      ret = (SIU_S26_SERVICE)this.get_Renamed("SERVICE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SIU_S26_SERVICE getSERVICE(int rep) { 
	   return (SIU_S26_SERVICE)this.get_Renamed("SERVICE", rep);
	}
...
{ 
	...
	public SIU_S26_GENERAL_RESOURCE  getGENERAL_RESOURCE() { 
	   ...
	   try {
	      ret = (SIU_S26_GENERAL_RESOURCE)this.get_Renamed("GENERAL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SIU_S26_GENERAL_RESOURCE getGENERAL_RESOURCE(int rep) { 
	   return (SIU_S26_GENERAL_RESOURCE)this.get_Renamed("GENERAL_RESOURCE", rep);
	}
...
{ 
	...
	public SIU_S26_LOCATION_RESOURCE  getLOCATION_RESOURCE() { 
	   ...
	   try {
	      ret = (SIU_S26_LOCATION_RESOURCE)this.get_Renamed("LOCATION_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SIU_S26_LOCATION_RESOURCE getLOCATION_RESOURCE(int rep) { 
	   return (SIU_S26_LOCATION_RESOURCE)this.get_Renamed("LOCATION_RESOURCE", rep);
	}
...
{ 
	...
	public SIU_S26_PERSONNEL_RESOURCE  getPERSONNEL_RESOURCE() { 
	   ...
	   try {
	      ret = (SIU_S26_PERSONNEL_RESOURCE)this.get_Renamed("PERSONNEL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public SIU_S26_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE(int rep) { 
	   return (SIU_S26_PERSONNEL_RESOURCE)this.get_Renamed("PERSONNEL_RESOURCE", rep);
	}
