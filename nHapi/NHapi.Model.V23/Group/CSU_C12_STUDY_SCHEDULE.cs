...
/**
 * <p>Represents the CSU_C12_STUDY_SCHEDULE Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: CSS (Clinical Study Data Schedule) <b>optional </b><br>
 * 1: CSU_C12_STUDY_OBSERVATION (a Group object) <b>optional repeating</b><br>
 * 2: CSU_C12_STUDY_PHARM (a Group object) <b>repeating</b><br>
 */
...
public class CSU_C12_STUDY_SCHEDULE : AbstractGroup {
	 ...
	 */
	public CSU_C12_STUDY_SCHEDULE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("CSS", "2.3"), false, false);
	      this.add(factory.getGroupClass("CSU_C12_STUDY_OBSERVATION", "2.3"), false, true);
	      this.add(factory.getGroupClass("CSU_C12_STUDY_PHARM", "2.3"), true, true);
...
get{
	...
	public CSU_C12_STUDY_OBSERVATION  getSTUDY_OBSERVATION() { 
	   ...
	   try {
	      ret = (CSU_C12_STUDY_OBSERVATION)this.get_Renamed("STUDY_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public CSU_C12_STUDY_OBSERVATION getSTUDY_OBSERVATION(int rep) { 
	   return (CSU_C12_STUDY_OBSERVATION)this.get_Renamed("STUDY_OBSERVATION", rep);
	}
...
{ 
	...
	public CSU_C12_STUDY_PHARM  getSTUDY_PHARM() { 
	   ...
	   try {
	      ret = (CSU_C12_STUDY_PHARM)this.get_Renamed("STUDY_PHARM");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(GetType()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
	...
	public CSU_C12_STUDY_PHARM getSTUDY_PHARM(int rep) { 
	   return (CSU_C12_STUDY_PHARM)this.get_Renamed("STUDY_PHARM", rep);
	}
