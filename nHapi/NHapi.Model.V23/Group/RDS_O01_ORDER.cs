...
public class RDS_O01_ORDER : AbstractGroup {
	...
	public RDS_O01_ORDER(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("RDS_O01_ORDER_DETAIL", "2.3"), false, false);
	      this.add(factory.getGroupClass("RDS_O01_ENCODING", "2.3"), false, false);
	      ...
	      this.add(factory.getGroupClass("RDS_O01_OBSERVATION", "2.3"), true, true);
