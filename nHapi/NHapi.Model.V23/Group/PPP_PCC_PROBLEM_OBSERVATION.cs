...
/**
 * <p>Represents the PPP_PCC_PROBLEM_OBSERVATION Group.  A Group is an ordered collection of message 
...
public class PPP_PCC_PROBLEM_OBSERVATION : AbstractGroup {
	 ...
	 */
	public PPP_PCC_PROBLEM_OBSERVATION(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
