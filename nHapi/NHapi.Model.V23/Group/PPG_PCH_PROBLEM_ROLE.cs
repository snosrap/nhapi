...
/**
 * <p>Represents the PPG_PCH_PROBLEM_ROLE Group.  A Group is an ordered collection of message 
...
public class PPG_PCH_PROBLEM_ROLE : AbstractGroup {
	 ...
	 */
	public PPG_PCH_PROBLEM_ROLE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(factory.getSegmentClass("ROL", "2.3"), true, false);
