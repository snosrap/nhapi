 ...
 * 1: CSU_C09_STUDY_OBSERVATION (a Group object) <b>optional repeating</b><br>
...
public class CSU_C09_STUDY_SCHEDULE : AbstractGroup {
	...
	public CSU_C09_STUDY_SCHEDULE(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("CSU_C09_STUDY_OBSERVATION", "2.3"), false, true);
	      this.add(factory.getGroupClass("CSU_C09_STUDY_PHARM", "2.3"), true, true);
