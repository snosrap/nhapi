...
public class SIU_S12_RESOURCES : AbstractGroup {
	...
	public SIU_S12_RESOURCES(Group parent, ModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(factory.getGroupClass("SIU_S12_SERVICE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SIU_S12_GENERAL_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SIU_S12_LOCATION_RESOURCE", "2.3"), false, true);
	      this.add(factory.getGroupClass("SIU_S12_PERSONNEL_RESOURCE", "2.3"), false, true);
