 ...
 * UB1-10: Value Amount & Code (46-49) (CM_UVC)<br> 
 * UB1-11: Number Of Grace Days (90) (NM)<br> 
 * UB1-12: Spec Program Indicator (44) (CE)<br> 
...
public class UB1 : AbstractSegment  {
  ...
  public UB1(Group parent, ModelClassFactory factory) : base(parent,factory) {
    ...
    try {
       ...
       this.add(typeof(NM), false, 1, 2, new System.Object[]{message});
       this.add(typeof(NM), false, 1, 2, new System.Object[]{message});
       this.add(typeof(IS), false, 5, 2, new System.Object[]{message, 43});
       ...
       this.add(typeof(ID), false, 1, 60, new System.Object[]{message, 0});
