...
namespace ca.uhn.hl7v2.validation
{
	...
	public class MessageValidator
	{
		...
		//UPGRADE_NOTE: The initialization of  'ourLog' was moved to static method 'ca.uhn.hl7v2.validation.MessageValidator'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
