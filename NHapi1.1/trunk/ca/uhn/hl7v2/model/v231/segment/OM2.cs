...
public class OM2 : AbstractSegment  {
  ...
  public OM2(Group parent, ModelClassFactory factory) : base(parent,factory) {
    ...
    try {
       ...
       this.add(typeof(RFR), false, 1, 200, new System.Object[]{message}, "Reference (Normal) Range - Ordinal & Continuous Obs");
       this.add(typeof(NR), false, 1, 200, new System.Object[]{message}, "Critical Range for Ordinal & Continuous Obs");
       this.add(typeof(RFR), false, 1, 200, new System.Object[]{message}, "Absolute Range for Ordinal & Continuous Obs");
