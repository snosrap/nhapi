...
///</summary>
[Serializable]
public class CK_PAT_ID : AbstractType, Composite{
	private Type[] data;
	...
	///</summary>
	public CK_PAT_ID(Message message) : this(message, null){}

	///<summary>
	/// Creates a CK_PAT_ID.
	/// <param name="message">The Message to which this Type belongs</param>
	///</summary>
	public CK_PAT_ID(Message message, string description) : base(message, description){
		data = new Type[4];
	...
	public Type getComponent(int number) { 
		...
		try { 
			...
			throw new DataTypeException("Element " + number + " doesn't exist in 4 element CK_PAT_ID composite"); 
		} 
	} 
	///<summary>
