...
namespace ca.uhn.hl7v2.model
{
	...
	public abstract class AbstractPrimitive:AbstractType, Primitive
	{
		...
		/// <seealso cref="ca.uhn.hl7v2.model.Primitive.getValue()">
		/// </seealso>
		...
		/// 
		/// </summary>
		/// <seealso cref="ca.uhn.hl7v2.model.Primitive.setValue(String)">
		/// </seealso>
		virtual public System.String Value
		{
			...
			set
			{
				...
				if (message != null)
				{
					...
					if (context != null)
					{
						PrimitiveTypeRule[] rules = context.getPrimitiveRules(version, TypeName, this);
