	...
	public class FAC : AbstractSegment  
	{
		...
		public FAC(Group parent, ModelClassFactory factory) : base(parent,factory) 
		{
			...
			try 
			{
				...
				this.add(typeof(XAD), true, 1, 200, new System.Object[]{message});
				...
				this.add(typeof(XCN), true, 1, 60, new System.Object[]{message});
				this.add(typeof(ST), false, 1, 60, new System.Object[]{message});
				this.add(typeof(XAD), false, 1, 200, new System.Object[]{message});
