...
///</summary>
[Serializable]
public class CM_WVI : AbstractType, Composite{
	private Type[] data;
	...
	///</summary>
	public CM_WVI(Message message) : this(message, null){}

	///<summary>
	/// Creates a CM_WVI.
	/// <param name="message">The Message to which this Type belongs</param>
	///</summary>
	public CM_WVI(Message message, string description) : base(message, description){
		data = new Type[2];
