...
namespace ca.uhn.hl7v2.util
{
	...
	public class Terser
	{
		...
		//UPGRADE_NOTE: The initialization of  'log' was moved to static method 'ca.uhn.hl7v2.util.Terser'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		...
		public static int[] getIndices(System.String spec)
		{
			...
			try
			{
				Tokenizer fieldSpec = new Tokenizer(tok.NextToken(), "()", false);
