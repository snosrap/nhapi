...
using MessageValidator = ca.uhn.hl7v2.validation.MessageValidator;
using ValidationContext = ca.uhn.hl7v2.validation.ValidationContext;
using DefaultValidation = ca.uhn.hl7v2.validation.impl.DefaultValidation;
...
namespace ca.uhn.hl7v2.parser
{
	...
	public abstract class Parser
	{
		...
		private static System.Collections.IDictionary MessageStructures
		{
			get
			{
				lock (typeof(ca.uhn.hl7v2.parser.Parser))
				{
		...
		//UPGRADE_NOTE: The initialization of  'log' was moved to static method 'ca.uhn.hl7v2.parser.Parser'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		...
		public static bool validVersion(System.String version)
		{
			...
			int c = 0;
			while (versionOK == false && c < Constants.VERSIONS.Length)
			{
				if (Constants.VERSIONS[c++].Equals(version))
					versionOK = true;
			}
			return versionOK;
		}
		...
		private static System.Collections.IDictionary loadMessageStructures()
		{
			lock (typeof(ca.uhn.hl7v2.parser.Parser))
			{
				...
				{
					System.String resource = "ca.uhn.hl7v2.parser.eventmap." + Constants.VERSIONS[i] + ".properties";
					...
					map[Constants.VERSIONS[i]] = structures;
				}
				return map;
			}
		}
