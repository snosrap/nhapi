...
/**
 * <p>Represents the RRE_O02_PATIENT Group.  A Group is an ordered collection of message 
...
namespace ca.uhn.hl7v2.model.v231.group
{
	...
	public class RRE_O02_PATIENT : AbstractGroup 
	{
		 ...
		 */
		public RRE_O02_PATIENT(Group parent, ModelClassFactory factory) : base(parent, factory)
		{
			try 
			{
