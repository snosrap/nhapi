...
namespace ca.uhn.hl7v2.model
{
	...
	public abstract class AbstractGroup : Group
	{
		...
		//UPGRADE_NOTE: The initialization of  'log' was moved to static method 'ca.uhn.hl7v2.model.AbstractGroup'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		...
		/// <summary> Returns the structure name (excluding package). </summary>
		...
		private System.String insert(System.Type c, bool required, bool repeating, int index, System.String name)
		{
			...
			//Modified by CDC.  This can break the parser if there are multiple ZN1, ZN2's when parsing and reparsing.
			if (nameExists(name))
			{
				int version = 2;
