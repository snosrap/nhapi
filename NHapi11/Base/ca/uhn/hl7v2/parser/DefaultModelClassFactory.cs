...
using GenericMessage = ca.uhn.hl7v2.model.GenericMessage;
using SourceGenerator = ca.uhn.hl7v2.sourcegen.SourceGenerator;
...
namespace ca.uhn.hl7v2.parser
{
	...
	public class DefaultModelClassFactory : ModelClassFactory
	{
		...
		//UPGRADE_NOTE: The initialization of  'log' was moved to static method 'ca.uhn.hl7v2.parser.DefaultModelClassFactory'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		...
		/// <seealso cref="ca.uhn.hl7v2.parser.ModelClassFactory.getGroupClass(java.lang.String, java.lang.String)">
		/// </seealso>
		...
		/// <seealso cref="ca.uhn.hl7v2.parser.ModelClassFactory.getSegmentClass(java.lang.String, java.lang.String)">
		/// </seealso>
		...
		/// <seealso cref="ca.uhn.hl7v2.parser.ModelClassFactory.getTypeClass(java.lang.String, java.lang.String)">
		/// </seealso>
		...
		private static string GetAssemblyName(string version)
		{
