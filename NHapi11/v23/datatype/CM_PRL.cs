...
///</summary>
[Serializable]
public class CM_PRL : AbstractType, Composite{
	private Type[] data;
	...
	///</summary>
	public CM_PRL(Message message) : this(message, null){}

	///<summary>
	/// Creates a CM_PRL.
	/// <param name="message">The Message to which this Type belongs</param>
	///</summary>
	public CM_PRL(Message message, string description) : base(message, description){
		data = new Type[3];
	...
	public Type getComponent(int number) { 
		...
		try { 
			...
			throw new DataTypeException("Element " + number + " doesn't exist in 3 element CM_PRL composite"); 
		} 
	} 
	///<summary>
