...
namespace NHapi.Model.V231.Message
{
    ...
    /// * 4: MRG (MRG - merge patient information segment-) optional 
    /// * 5: NK1 (NK1 - next of kin / associated parties segment-) optional repeating
    /// * 6: PV1 (PV1 - patient visit segment-) 
    /// * 7: PV2 (PV2 - patient visit - additional information segment) optional 
    /// * 8: DB1 (DB1 - Disability segment) optional repeating
    /// * 9: OBX (OBX - observation/result segment) optional repeating
    /// * 10: AL1 (AL1 - patient allergy information segment) optional repeating
    /// * 11: DG1 (DG1 - diagnosis segment) optional repeating
    /// * 12: DRG (DRG - diagnosis related group segment) optional 
    /// * 13: ADT_A06_PROCEDURE (a Group object) optional repeating
    /// * 14: GT1 (GT1 - guarantor segment) optional repeating
    /// * 15: ADT_A06_INSURANCE (a Group object) optional repeating
    /// * 16: ACC (ACC - accident segment) optional 
    /// * 17: UB1 (UB1 - UB82 data segment) optional 
    /// * 18: UB2 (UB2 - UB92 data segment) optional 
    ///</summary>
    [Serializable]
