...
namespace NHapi.Model.V231.Message
{
    ...
    /// * 8: PID (PID - patient identification segment) 
    /// * 9: PD1 (PD1 - patient additional demographic segment) optional 
    /// * 10: PV1 (PV1 - patient visit segment-) 
    /// * 11: PV2 (PV2 - patient visit - additional information segment) optional 
    /// * 12: DB1 (DB1 - Disability segment) optional repeating
    /// * 13: OBX (OBX - observation/result segment) optional repeating
    ///</summary>
    [Serializable]
