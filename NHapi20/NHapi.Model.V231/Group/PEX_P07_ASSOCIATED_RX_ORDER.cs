...
namespace NHapi.Model.V231.Group
{
    ...
    /// * 0: RXE (RXE - pharmacy/treatment encoded order segment) 
    /// * 1: RXR (RXR - pharmacy/treatment route segment) optional repeating
    ///</summary>
    [Serializable]
    public class PEX_P07_ASSOCIATED_RX_ORDER : AbstractGroup
    {
        ...
        ///</summary>
        public PEX_P07_ASSOCIATED_RX_ORDER(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
            try
            {
