...
namespace NHapi.Model.V231.Group
{
    ...
    /// * 2: PV1 (PV1 - patient visit segment-) optional 
    /// * 3: PV2 (PV2 - patient visit - additional information segment) optional 
    ...
    public class SIU_S12_PATIENT : AbstractGroup
    {
        ...
        ///</summary>
        public SIU_S12_PATIENT(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
            try
            {
