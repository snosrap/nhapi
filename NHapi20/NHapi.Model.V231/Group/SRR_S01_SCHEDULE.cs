...
namespace NHapi.Model.V231.Group
{
    ...
    /// * 0: SCH (SCH - schedule activity information segment) 
    /// * 1: NTE (NTE - notes and comments segment) optional repeating
    /// * 2: SRR_S01_PATIENT (a Group object) optional repeating
    /// * 3: SRR_S01_RESOURCES (a Group object) repeating
    ///</summary>
    [Serializable]
    public class SRR_S01_SCHEDULE : AbstractGroup
    {
        ...
        ///</summary>
        public SRR_S01_SCHEDULE(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
            try
            {
