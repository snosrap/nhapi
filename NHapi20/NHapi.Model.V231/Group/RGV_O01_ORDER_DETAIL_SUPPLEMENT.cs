...
namespace NHapi.Model.V231.Group
{
    ...
    /// * 0: NTE (NTE - notes and comments segment) repeating
    /// * 1: RXR (RXR - pharmacy/treatment route segment) repeating
    /// * 2: RGV_O01_COMPONENTS (a Group object) optional 
    ///</summary>
    [Serializable]
    public class RGV_O01_ORDER_DETAIL_SUPPLEMENT : AbstractGroup
    {
        ...
        ///</summary>
        public RGV_O01_ORDER_DETAIL_SUPPLEMENT(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
            try
            {
