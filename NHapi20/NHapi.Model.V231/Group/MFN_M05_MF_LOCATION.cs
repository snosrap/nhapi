...
namespace NHapi.Model.V231.Group
{
    ...
    /// * 1: LOC (LOC - location identification segment) 
    /// * 2: LCH (LCH - location characteristic segment) optional repeating
    /// * 3: LRL (LRL - location relationship segment) optional repeating
    /// * 4: MFN_M05_MF_LOC_DEPT (a Group object) repeating
    ///</summary>
    [Serializable]
    public class MFN_M05_MF_LOCATION : AbstractGroup
    {
        ...
        ///</summary>
        public MFN_M05_MF_LOCATION(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
            try
            {
