...
namespace NHapi.Model.V231.Group
{
    ...
    /// * 3: AL1 (AL1 - patient allergy information segment) optional repeating
    /// * 4: RDS_O01_PATIENT_VISIT (a Group object) optional 
    ///</summary>
    [Serializable]
    public class RDS_O01_PATIENT : AbstractGroup
    {
        ...
        ///</summary>
        public RDS_O01_PATIENT(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
            try
            {
