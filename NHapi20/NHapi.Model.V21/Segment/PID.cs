...
namespace NHapi.Model.V21.Segment
{
    ...
    /// * PID-17: RELIGION (ID)
    /// * PID-18: PATIENT ACCOUNT NUMBER (CK)
    /// * PID-19: SSN NUMBER - PATIENT (ST)
    /// * PID-20: DRIVER'S LIC NUM - PATIENT (CM)
