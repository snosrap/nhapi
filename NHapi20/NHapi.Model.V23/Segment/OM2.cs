...
namespace NHapi.Model.V23.Segment
{
    ...
    /// * OM2-6: Reference (Normal) Range - Ordinal and Continuous Obs (CM_RFR)
    /// * OM2-7: Critical Range for Ordinal and Continuous Obs (CM_RANGE)
    /// * OM2-8: Absolute Range for Ordinal and Continuous Obs (CM_ABS_RANGE)
    /// * OM2-9: Delta Check Criteria (CM_DLT)
