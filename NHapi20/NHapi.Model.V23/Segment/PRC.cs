...
namespace NHapi.Model.V23.Segment
{
    ...
    /// * PRC-1: Primary Key Value (CE)
    /// * PRC-2: Facility ID (EI)
    /// * PRC-3: Department (CE)
    /// * PRC-4: Valid Patient Classes (ID)
    /// * PRC-5: Price (CP)
    /// * PRC-6: Formula (ST)
    ...
    public class PRC : AbstractSegment
    {
         ...
         * message.  
         */
        public PRC(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
