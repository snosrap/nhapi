...
namespace NHapi.Model.V23.Group
{
    ...
    /// * 3: PGL_PC8_PROBLEM_ROLE (a Group object) optional repeating
    /// * 4: PGL_PC8_PROBLEM_OBSERVATION (a Group object) optional repeating
    ///</summary>
    [Serializable]
    public class PGL_PC8_PROBLEM : AbstractGroup
    {
        ...
        ///</summary>
        public PGL_PC8_PROBLEM(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
            try
            {
