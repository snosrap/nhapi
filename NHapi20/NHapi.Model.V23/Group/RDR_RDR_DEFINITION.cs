...
namespace NHapi.Model.V23.Group
{
    ...
    /// * 0: QRD (Query definition segment) 
    /// * 1: QRF (Query filter segment) optional 
    /// * 2: RDR_RDR_PATIENT (a Group object) optional 
    /// * 3: RDR_RDR_ORDER (a Group object) repeating
    ///</summary>
    [Serializable]
    public class RDR_RDR_DEFINITION : AbstractGroup
    {
        ...
        ///</summary>
        public RDR_RDR_DEFINITION(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
            try
            {
