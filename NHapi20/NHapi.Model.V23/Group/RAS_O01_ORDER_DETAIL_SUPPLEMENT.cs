...
namespace NHapi.Model.V23.Group
{
    ...
    /// * 0: NTE (Notes and comments segment) repeating
    /// * 1: RXR (Pharmacy route segment) repeating
    /// * 2: RAS_O01_COMPONENTS (a Group object) optional 
    ///</summary>
    [Serializable]
    public class RAS_O01_ORDER_DETAIL_SUPPLEMENT : AbstractGroup
    {
        ...
        ///</summary>
        public RAS_O01_ORDER_DETAIL_SUPPLEMENT(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
            try
            {
