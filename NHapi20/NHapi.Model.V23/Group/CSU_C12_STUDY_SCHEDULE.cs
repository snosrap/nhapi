...
namespace NHapi.Model.V23.Group
{
    ...
    /// * 1: CSU_C12_STUDY_OBSERVATION (a Group object) optional repeating
    /// * 2: CSU_C12_STUDY_PHARM (a Group object) repeating
    ///</summary>
    [Serializable]
    public class CSU_C12_STUDY_SCHEDULE : AbstractGroup
    {
        ...
        ///</summary>
        public CSU_C12_STUDY_SCHEDULE(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
            try
            {
