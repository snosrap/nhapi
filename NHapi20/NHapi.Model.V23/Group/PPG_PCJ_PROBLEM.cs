...
namespace NHapi.Model.V23.Group
{
    ...
    /// * 3: PPG_PCJ_PROBLEM_ROLE (a Group object) optional repeating
    /// * 4: PPG_PCJ_PROBLEM_OBSERVATION (a Group object) optional repeating
    ///</summary>
    [Serializable]
    public class PPG_PCJ_PROBLEM : AbstractGroup
    {
        ...
        ///</summary>
        public PPG_PCJ_PROBLEM(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
            try
            {
