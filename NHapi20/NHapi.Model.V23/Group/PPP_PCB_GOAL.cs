...
namespace NHapi.Model.V23.Group
{
    ...
    /// * 3: PPP_PCB_GOAL_ROLE (a Group object) optional repeating
    /// * 4: PPP_PCB_GOAL_OBSERVATION (a Group object) optional repeating
    ///</summary>
    [Serializable]
    public class PPP_PCB_GOAL : AbstractGroup
    {
        ...
        ///</summary>
        public PPP_PCB_GOAL(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
            try
            {
