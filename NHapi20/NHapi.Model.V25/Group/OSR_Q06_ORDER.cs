...
/// * 0: ORC (Common Order) 
/// * 1: OSR_Q06_TIMING (a Group object) 
/// * 2: OBR (Observation Request) 
/// * 3: RQD (Requisition Detail) 
/// * 4: RQ1 (Requisition Detail-1) 
/// * 5: RXO (Pharmacy/Treatment Order) 
/// * 6: ODS (Dietary Orders, Supplements, and Preferences) 
/// * 7: ODT (Diet Tray Instructions) 
